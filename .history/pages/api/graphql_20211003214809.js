...
const Description = {
  ...
  index: 'materielnet',
  hits: {
    fields: ['product_names','description','marques','categories','product_links','product_prices','vendeurs_image','villes1','adresses','telephone1','telephone2','fix1','email','facebook','instagram','horaires','localisation', 'stocks']
  },
  sortOptions: [
