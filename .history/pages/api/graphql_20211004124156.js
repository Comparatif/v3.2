        ...
        bool: {
          must: [{
            multi_match: {
                ...
                operator: sortLabel == 'Prix : par ordre croissant' ? "and" :"or"
...
const server = new ApolloServer({
  typeDefs: [
    gql`
    type Query @cacheControl(maxAge: 25000000) {
      root: String
    }

    type HitFields @cacheControl(maxAge: 25000000) {
      vendeurs: String
    ...
    type ResultHit implements SKHit @cacheControl(maxAge: 25000000) {
      id: ID!
      fields: HitFields
      customField: String
    }

    type DescriptionHitFields @cacheControl(maxAge: 25000000) {
      product_names: String
      description1: String
      brand_name: String
      description2: String
    ...
    type DescriptionHit implements SKHit @cacheControl(maxAge: 25000000) {
      id: ID!
    ...
    extend type Query @cacheControl(maxAge: 25000000) {
