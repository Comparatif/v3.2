...
const Description = {
  ...
  index: 'materielnet',
  hits: {
    fields: ['product_names','description1','brand_name','description2','prod_description','prod_specs','vendeurs_image','villes1','adresses','telephone1','telephone2','fix1','email','facebook','instagram','horaires','localisation', 'stocks']
  },
  sortOptions: [
