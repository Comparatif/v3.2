...
const searchkitConfig = {
  ...
  index: 'comparatifdz',
  hits: {
    fields: ['vendeurs','product_names','product_imagelinks','marques','categories','product_links','product_prices','vendeurs_image','villes1','adresses','telephone1','telephone2','fix1','email','facebook','instagram','horaires','localisation', 'stocks', 'shop_website', 'product_country', 'commune', 'livraison' 'date']
  },
  sortOptions: [
