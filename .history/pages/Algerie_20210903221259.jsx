...
const myCustomStateToRouteFn = (searchState) => {
  const queryOpt = searchState.sortBy === "prix_croissant" ? { fields: ["and"]} : { fields: ["or"]}
  const routeState = {
    ...
    size: {},
    from: {},
    queryOptions: { fields: ["and"]}
  }
  console.log(searchState.sortBy)
...
const myCustomRouteToStateFn = (routeState) => (
  ...
  page: {}, 
  queryOptions: routeState.sort === "prix_croissant" ? { fields: ["and"]} : { fields: ["or"]}
