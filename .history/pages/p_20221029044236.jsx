...
import AutoCompleteText_recherche from '../components/autocomplete/AutoCompleteText_recherche';
import {NavBar} from '../components/navbar/navbar';
import Footer from '../components/footer/footer';
import liste from '../components/autocomplete/liste.js'
...
import { HitsList } from '../components/searchkit/Hits_composants_pc.jsx'
  ...
  <header className="bg-gradient-dark position-fixed w-100 z-index-2">
    <div className="page-header" id="page-header-custom-recherche">
      ...
      <div className="position-absolute w-100 z-index-1 bottom-0">
        ...
        <svg className="waves-custom" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 40" preserveAspectRatio="none" shape-rendering="auto" >
          <defs>
  ...
  export default withApollo(withSearchkit(withSearchkitRouting
    (Page, {
      ...
      createURL: ({ qsModule, location, routeState }) => {
        ...
        return `/p?${queryString.replace('query=', '')}`}
