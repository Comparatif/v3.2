...
export default  ({ Component, pageProps }) => {
  ...
  useEffect(() => {
    import("/static/js/soft-design-system.min");
    import("/static/scroll");
    import("/static/js/plugins/parallax");
    import("/static/js/plugins/perfect-scrollbar");
    import("/static/darkmode");
    import("/static/messenger");
    import("/static/js/core/bootstrap");
    import("/static/js/core/popper");
