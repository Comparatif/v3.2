...
export async function getStaticPaths() {
  ...
  const posts = [{url : 'http://localhost:3000/Algerie/informatique/Composants_pc?query=AMD-Ryzen-5-5600X'},
{url : 'http://localhost:3000/Algerie/informatique/Composants_pc?query=AMD-Ryzen-7-5800X'}]

  // Get the paths we want to pre-render based on posts
  const paths = posts.map((post) => ({
    params: { Algerie: post.url },
  }))
