...
const myCustomStateToRouteFn = (searchState) => {
  ...
  export default withApollo(withSearchkit(withSearchkitRouting
    ...
    parseURL: ({ qsModule, location }) => {
      ...
      const routeState = qsModule.parse("query=" + location.search.replace('-Prix-Algerie', '').slice(1), { arrayLimit: 99, addQueryPrefix: false })
      console.log("query=" + location.search.replace('-Prix-Algerie', ''))
