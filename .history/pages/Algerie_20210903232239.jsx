...
const myCustomStateToRouteFn = (searchState) => {
  searchState.sortBy === "prix_croissant" ? cartItemsVar('and') : cartItemsVar('or')
if(searchState.sortBy === "prix_croissant") {cartItemsVar('and')}
if(searchState.sortBy === "prix_croissant") {cartItemsVar('or')}
...
export default withApollo(withSearchkit(withSearchkitRouting(Search, {
  ...
  createURL: ({ qsModule, location, routeState }) => {
    routeState.sort === "prix_croissant" ? cartItemsVar('and') : cartItemsVar('or')
    if (location) {
    let filters
