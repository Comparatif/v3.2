...
if (data?.results.summary.total > 0) {return LaPageAvecResultats}
 else {return LaPageSansResultats, if (typeof window !== 'undefined') {return router.push('/Samsung-870-EVO-250-Go&sort=relevance'),
...
Page.getInitialProps = ctx => {
  ...
  if (ctx.res) {
    ctx.res.writeHead(302, { Location: '/Samsung-870-EVO-250-Go&sort=relevance' });
    ctx.res.end();
  }
  return { };
}
