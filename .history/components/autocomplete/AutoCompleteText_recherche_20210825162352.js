...
export default class AutoCompleteText_recherche extends React.Component {
  ...
  url = () => {
    ...
    const value = SearchkitIndex()

      this.setState(() => ({suggestions, url: value}));
  }
  ...
  <form action={'/Algerie/informatique/'+ SearchkitIndex() + '?query=' + text} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
