...
class AutoCompleteText_recherche extends React.Component {
  ...
  renderSuggestions () {
    ...
    return (
      ...
      onClick={() => {this.suggestionSelected(item);setQuery(item); api.setQuery(item); api.search()}}>
      
      <a class="a-autocomplete text-white" >
  ...
  <form action={()=> {setQuery(text); api.setQuery(text); api.search()}} method="post" class="form-autocomplete-ligne">
    <div class="tb">
      <div class="td">
      ...
      <div class="td" id="s-cover">
        ...
        <button type="submit" class="autocomplete-button-ligne">
          <div id="s-circle"></div>
