...
class AutoCompleteText_ligne extends React.Component {
  ...
  render() {
    ...
    const newlist = (newtext) => listOfItems.map((item) => { return item == itemToReplace ? newtext : item}).join("##!;#2")
    console.log(id)
    console.log(itemToReplace)
    console.log(listOfItems)
    console.log(listOfItems.map(function(item) { return item == itemToReplace ? "text" : item}))
    console.log(listOfItems.map(function(item) { return item == itemToReplace ? "text" : item}).join("##!;#2"))
