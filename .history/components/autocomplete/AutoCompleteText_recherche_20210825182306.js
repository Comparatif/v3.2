...
function withMyHook() {
  return function WrappedComponent(props) {
    ...
    const myHookValue = useReactiveVar(SearchkitIndex);
    return {myHookValue)
}
...
class AutoCompleteText_recherche extends React.Component {
  ...
  <form action={'/Algerie/informatique/'+ {myHookValue} + '?query=' + text} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
...
export default withMyHook(AutoCompleteText_recherche)
