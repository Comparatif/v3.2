...
export default class AutoCompleteText_recherche extends React.Component {
  ...
  renderSuggestions () {
    ...
    return (
      ...
      href={'/Algerie/informatique/'+ index + '?query=' +item.replace(/ /g, '-')} 
      rel="noreferrer">
  ...
  <form action={'/Algerie/informatique/'+ index + '?query=' + text} onClick={()=> setTitle(text)} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
      <input class="autocomplete-input" value= {text} onChange={this.onTextChanged, setTitle(text)} type="text" placeholder="Rechercher ..."/>
