...
export default class AutoCompleteText_recherche extends React.Component {
  ...
  renderSuggestions () {
    const test =()=> {if (typeof window !== "undefined") {
    ...
    return (
      ...
      href={'https://comparatifdz.com/' + item.replace(/ /g, '-')} 
      rel="noreferrer">
  ...
  <form action={'https://comparatifdz.com/' + text} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
