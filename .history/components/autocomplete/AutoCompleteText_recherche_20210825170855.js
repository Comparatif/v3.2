...
export default class AutoCompleteText_recherche extends React.Component {
  ...
  onTextChanged = (e) => {
    ...
    if (value.length > 0) {
      ...
      this.setState(() => ({suggestions, text: value, url : SearchkitIndex()}));
  }
  ...
  <form action={'/Algerie/informatique/'+ url + '?query=' + text} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
