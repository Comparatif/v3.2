...
function withMyHook(Component) {
  return function WrappedComponent(props) {
    ...
    return <Component {...props} myHookValue={useReactiveVar(SearchkitIndex)} />;
  }
}
...
export default class AutoCompleteText_recherche extends React.Component {
  ...
  <form action={'/Algerie/informatique/'+ useReactiveVar(SearchkitIndex) + '?query=' + text} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
