...
class AutoCompleteText_recherche extends React.Component {
  ...
  renderSuggestions () {
    ...
    return (
      ...
      <a 
      href={'http://localhost:3000/' + item.replace(/ /g, '-')} 
  ...
  <form action={text} method="post" class="form-autocomplete">
    <div class="tb">
      <div class="td">
      <input class="autocomplete-input" value= {text.replace(/ /g, '-')} onChange={this.onTextChanged} type="text" placeholder="Rechercher ..."/>
