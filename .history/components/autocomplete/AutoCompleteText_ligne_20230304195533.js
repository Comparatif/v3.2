...
class AutoCompleteText_ligne extends React.Component {
  ...
  renderSuggestions () {
    ...
    return (
      ...
      setQuery(item); api.setQuery(item); api.search(); toggleIsOn()}}>
  ...
  <form className="form-autocomplete-ligne">
    <div className="tb">
      ...
      <div className="td" id="s-cover-ligne">
        ...
        <button type="submit" className="autocomplete-button-ligne" onClick={()=>{setQuery(text); api.setQuery(text); api.search(); toggleIsOn()}} >
