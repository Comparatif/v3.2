...
useEffect(()=>{
  ...
  <header class="bg-gradient-dark position-fixed w-100 z-index-2">
    ...
    <svg class="waves-custom bg-gradient-info" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 40" preserveAspectRatio="none" shape-rendering="auto" >
      <defs>
        <path id="gentle-wave" d="M-160 44c30 0 58-18 88-18s 58 18 88 18 58-18 88-18 58 18 88 18 v44h-352z" />
      </defs>
      <g class="moving-waves">
    
        <use xlinkHref="#gentle-wave" x="48" y="0" fill="rgba(255,255,255,0)" ></use>
      </g>
    </svg>
  </div>
  </header>
