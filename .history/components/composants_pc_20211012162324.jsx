...
const Page = () => {
  ...
  const { previousData, data = previousData, loading } = useQuery(query, { variables })
    ...
    return (
      ...
      <meta name="description" content={!names_bdd ? product_names : names_bdd + " prix Algérie | " + description1  + " | " + categories + " | " + !brand_name ? marque :  + " | " + "Meilleur prix : " + product_prices + " DA"}/>
