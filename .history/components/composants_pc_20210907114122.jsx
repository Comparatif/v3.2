...
const Page = () => {
  ...
  return new bootstrap.Tooltip(tooltipTriggerEl)
    ...
    return (
      ...
      <meta name="description" content={"Prix le moins cher : " + price + " DA | "+ hit.fields.categories + " : "+ hit.fields.product_names + " | Marque : " + hit.fields.marques + " | Boutique : " +hit.fields.vendeurs}/>
