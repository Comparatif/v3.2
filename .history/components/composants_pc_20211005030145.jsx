...
const Page = () => {
  ...
  const { previousData, data = previousData, loading } = useQuery(query, { variables })
    ...
    return (
      ...
      <meta property="og:title" content= {names +" prix Algérie - Comparatif comparatif Algérie - Prix, stocks & avis"} />
      ...
      <meta name="keywords" content= {names + " | "+ categories + "Meilleur prix Algérie - Comparatif, gaming, config, ryzen, intel, HP, ASUS, MSI, NVIDIA, AMD, RTX, GTX"}/>
