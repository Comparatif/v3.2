...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <div class="modal fade" id={cle} tabindex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
          ...
          <a href={shop_website}>
          <Image class="img-fluid border-radius-lg " style={imgWidth}  fill src={vendeurs_image} alt={vendeurs}/>
          </a>
          ...
          <Image width= "75%" height="auto" src={product_imagelinks} />
          </div>
...
/>
  <Auth cle={cle} CanvasState={CanvasState}  user={user}/>
    ...
    <Image style={imgWidthBlur}  width="60%" height="auto" src="/blur/4.jpg"  class="img-fluid border-radius-lg" />
    </a>
