...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          ...
          <strong>Pays </strong>: <img src={hit.fields.product_country == "Algérie" ? "/img/custom/2634506_algeria_ensign_flag_nation_icon.png" : "" } style={{width: "7%", height: "7%", borderRadius: "1px", boxShadow: "0 0 5px black"}}></img> {hit.fields.product_country} <br/>
