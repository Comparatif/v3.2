    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <a class="text-center" href={isBrowser ? window.location.href : ''}>
                    ...
                    <p>
                    <small >
                  {!names_bdd ? "" : description1}  <Image src="/img/custom/info.svg" title="" data-bs-original-title="Beta : la description peut ne pas correspondre a la recherche dans certains cas."   data-bs-toggle="tooltip" data-bs-placement="right"/></small></p>
                  </a>
