...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {typeof hit.fields.paiement.toString().test("Baridimob")  ? "/img/custom/baridimob.png" : "1"}
    {typeof hit.fields.paiement.toString().test("CCP")  ? <img class="w-25" src="/img/custom/ccp.png"/> : "2"}
