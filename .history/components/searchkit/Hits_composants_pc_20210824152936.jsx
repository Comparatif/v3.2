...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {Object.values(hit.fields.paiement).includes("Baridimob") ? <img class="w-25" src="/img/custom/baridimob.png"/> : ""}
    {Object.values(hit.fields.paiement).includes("CCP") ? <img class="w-25" src="/img/custom/ccp.png"/> : ""}
