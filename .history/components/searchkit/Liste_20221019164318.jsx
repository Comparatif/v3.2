...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <div class="modal fade" id={cle} tabindex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
          ...
          <a href={shop_website}>
          <Image class="img-fluid border-radius-lg " style={imgWidth} style={imgWidth} src={vendeurs_image} alt={vendeurs}/>
          </a>
...
/>
  <Auth cle={cle} CanvasState={CanvasState}  user={user}/>
    ...
    <Image style={imgWidthBlur} src="/blur/4.jpg"  class="img-fluid border-radius-lg" style={{filter: "blur(1rem)", width: "60%"}}/>
    </a>
