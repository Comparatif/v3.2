...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          ...
          <strong>Mobile 1 </strong>: <a href={"tel:" + hit.fields.telephone1}></a>{hit.fields.telephone1} <br/>
          <strong>Mobile 2 </strong>: <a href={"tel:" + hit.fields.telephone2}></a>{hit.fields.telephone2} <br/>
          <strong>Téléphone fix </strong>: <a href={"tel:" + hit.fields.telephone2}></a>{hit.fields.telephone2}<br/>
