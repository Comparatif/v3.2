...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-3 col-md-3 col-sm-4 col-4 mb-1 pe-1" >
    ...
    <div class="col-lg-3 col-md-2 col-sm-2 col-2 mb-1" >
    {hit.fields.paiement.toString().includes("CCP") ? <img class="shadow col-lg-3 col-md-6 col-sm-3 col-3" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
