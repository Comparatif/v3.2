...
<div class='col-md-3 col-sm-3 col-4 mt-0 ps-0 text-center'>
  <Facets data={data.results}/>
  </div>

 
  <div class='col-md-5 col-sm-6 col-4 mt-0 text-center'>
  

   <div class="row justify-content-center">
   
      <div class=" col-md-3 col-sm-4 col-3 pe-1" >
         <button type="button"  class={viewType === "Liste" ? "btn bg-gradient-info mb-0 " : "btn mb-0  "} onClick={Liste}  >
         Liste
         </button>
      </div>   
      <div class=" col-md-3 col-sm-4 col-6 ps-1" >
         <button type="button"  class={viewType === "Grille" ? "btn bg-gradient-info mb-0  " : "btn mb-0  "} onClick={Grille} >
         Grille
         </button>
      </div>
...
<div class="col-md-3 col-sm-3 col-4 mt-0 pe-0 text-center">
