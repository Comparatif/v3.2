...
<div class='col-md-4 col-sm-4 col-4 mt-0 text-center'>
  ...
  <div class='col-md-3 col-sm-3 col-3 mt-0 text-center'>
  <div class="nav-wrapper position-relative end-0">
   <ul class="nav nav-pills nav-fill p-1" role="tablist">
      ...
      <div class="moving-tab position-absolute nav-link" style={{padding: "0px", transition: "all 0.5s ease 0s", transform: "translate3d(95px, 0px, 0px)", width: "90px"}}>
