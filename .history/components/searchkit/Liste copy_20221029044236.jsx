...
useEffect(()=> 
  ...
  <div key={cle} className="container card shadow-lg ">
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    <h2 className="mt-1 mx-1 mb-0 title-fontsize-h2" id="title-style">{product_names}</h2>
    </a>
    </div>
    <div className="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 pe-1" >
      <h3 className="text-gradient text-info ms-1 mb-0 title-fontsize-h1" id="state1" id="price-fontsize">{product_prices.replace(/\B(?=(\d{3})+(?!\d))/g, " ")} DA</h3>
    ...
    <img className="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
    {paiement.toString().includes("aridi") ? 
    <img className="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    {paiement.toString().includes("paypal") ? 
    <img className="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="Paypal" src="/img/custom/1156727_finance_payment_paypal_icon.png"/> : ""}
    {paiement.toString().includes("visa") ? 
    <img className="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="visa" src="/img/custom/206684_visa_method_card_payment_icon.png"/> : ""}
    {paiement.toString().includes("CIB") ? 
    <img className="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="CIB" src="/img/custom/CIB.png"/> : ""}
    {paiement.toString().includes("DAHABIA") ? 
    <img className="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="dahabia" src="/img/custom/edahabia_gold-300x190.png"/> : ""}
    </div>
