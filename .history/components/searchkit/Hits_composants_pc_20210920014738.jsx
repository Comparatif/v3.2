    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                if (screen.width < 767.98){
                  ...
                  <div class="col-6">
                  <button class="btn bg-gradient-info " onClick={toggleIsOn2}>Description</button>
                  </div>
                 ...
                 <td  dangerouslySetInnerHTML={{__html: prod_description.replace('<div>', '<div class="style={{maxHeight: '300px', overflowY: 'scroll'}}'")
