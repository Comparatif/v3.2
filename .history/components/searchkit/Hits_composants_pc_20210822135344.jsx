...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          ...
          <strong>Réseau sociaux </strong>: <a href={hit.fields.facebook ? hit.fields.facebook : ""}><img src="/img/custom/317727_facebook_social media_social_icon.png" class="w-25 h-25"></img></a> <a href={hit.fields.instagram ? hit.fields.instagram : ""}><img src="/img/custom/3225191_app_instagram_logo_media_popular_icon.png"></img></a>
