...
export const HitsList = ({ data }) => {
  ...
  const transformer = { cursor: "pointer", backgroundColor:"blue", width:"90%"} 
...
<div class='col-md-4 col-sm-4 col-4 mt-0 text-center'>
  ...
  <div class='col-md-4 col-sm-4 col-4 mt-0 text-center'>
  <div class="container"><div class="row justify-content-center"></div></div>
  <div class="nav-wrapper position-relative end-0">
   <ul class="nav nav-pills nav-fill p-1" role="tablist">
   
      <li class="nav-item" >
         <a  class="nav-link mb-0 px-0 py-1" style= {viewType === "Liste" ? transformer : {backgroundColor: "white", cursor: "pointer", width:"90%"}} onClick={Liste} data-bs-toggle="tab"  role="tab" aria-controls="profile" >
         Liste
         </a>
      </li>
      ...
      <li class="nav-item" >
         <a  class="nav-link mb-0 px-0 py-1" style= {viewType === "Grille" ? transformer : {backgroundColor: "white", cursor: "pointer", width:"90%"}} onClick={Grille} data-bs-toggle="tab"  role="tab" aria-controls="dashboard" >
         Grille
         </a>
      </li>
