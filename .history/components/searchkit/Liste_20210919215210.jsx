    ...
    {useEffect(()=>
      
      {
        if (livraison != undefined) {
          if (livraison.toString().includes("UPS")) {
return <img title="" data-bs-original-title={"Livraison: " + livraison} data-bs-toggle="tooltip" data-bs-placement="top" class="col-lg-12 col-md-12 col-sm-12 col-12" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"75%"}} alt= "Livraison" src="/img/custom/UPS-Icon.png"/>

          }
          else if (livraison.toString().includes(" ")) {
return <img title="" data-bs-original-title={"Livraison: " + livraison} data-bs-toggle="tooltip" data-bs-placement="top" class="col-lg-12 col-md-12 col-sm-12 col-12" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"75%"}} alt= "Livraison" src="/img/custom/shipped-icon-13.jpg"/>
