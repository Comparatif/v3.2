...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <img class="shadow col-lg-6 col-md-6 col-sm-6 col-6" data-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="This is a very beautiful popover, show some love.">
    
  
  style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
