...
<div class='col-md-3 col-sm-4 col-4 mt-0 text-center'>
  ...
  <div class='col-md-6 col-sm-4 col-4 mt-0 text-center'>
   ...
   <div class="container p-0"><div class="row justify-content-center">
      ...
      <div class="nav-item col-md-6 col-sm-6 col-6 pe-1" >
         <button type="button"  class={viewType === "Liste" ? "btn bg-gradient-info mb-0 px-0 py-1" : "btn mb-0 px-0 py-1"} onClick={Liste}  >
         Liste
         </button>
      </div>
      ...
      <div class="nav-item col-md-6 col-sm-6 col-6 ps-1" >
         <button type="button"  class={viewType === "Grille" ? "btn bg-gradient-info mb-0 px-0 py-1" : "btn mb-0 px-0 py-1"} onClick={Grille} >
         Grille
         </button>
      </div>
