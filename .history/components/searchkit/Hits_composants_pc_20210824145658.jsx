...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {hit.fields.paiement.match(/informatique\/(\w+)/) ? <img class="w-25" src="/img/custom/baridimob.png"/> : ""}
    {hit.fields.paiement.indexOf("ccp") ? <img class="w-25" src="/img/custom/ccp.png"/> : ""}
