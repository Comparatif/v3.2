    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <div class="card-body px-1 pt-3 pb-0">
                  ...
                  <button onClick={onLinkClick} type="button" class="btn bg-gradient-info btn-lg w-100">Comparer {data?.searchkit2.summary.total} offres</button>
                  <p class="small mb-0">
...
<div class="col-md-7 mb-1" id="results1">
...
<div class="container">
<div class="row justify-content-center text-start">
<div class="dropdown col-md-6 col-sm-6 col-6 mt-0 text-center">
...
{data?.searchkit2.hits.items.map((hit) => (
  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <div class="col-md-4 col-sm-4 col-4 mb-1 text-end ps-1 pe-3" >
          ...
          target="_blank" rel="noreferrer"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-1" id="btn-fontsize" data-animation="true">Voir l'offre</button></a>
