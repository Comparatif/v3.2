...
var tooltipListB = tooltipTriggerList.map(function (tooltipTriggerEl) {
  ...
  var tooltipB = bootstrap.Tooltip.getInstance(tooltipTriggerEl)
  return tooltipB

})
CanvasState == "Off" ?  tooltipList.forEach((e)=> e.enable()) : 
...
useEffect(()=> 
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {useEffect(()=> 
      {
        var elem = document.getElementsByClassName("myDiv")[0]
