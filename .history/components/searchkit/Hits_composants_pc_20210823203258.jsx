...
export const HitsList = ({ data }) => {
  ...
  const transformer = ChangeView() === 'Liste' ? {, cursor: "pointer"padding: "0px", transition: "all 0.5s ease 0s", transform: "translate3d(0px, 0px, 0px)", width: "49%"} : {padding: "0px", transition: "all 0.5s ease 0s", transform: "translate3d(0px, 0px, 0px)", width: "49%"}
