  ...
  <div class="px-sm-0">
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <a href={window.location.href} class="title-fontsize-h1 text-gradient text-info" style={{textDecoration: 'underline'}}>
                
                    <h1 class="title-fontsize-h1 text-gradient text-info" >
