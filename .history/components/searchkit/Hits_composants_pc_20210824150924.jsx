...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <img class="w-25" src={typeof hit.fields.paiement.includes("baridi") ? "/img/custom/baridimob.png" : ""}/>
    {typeof hit.fields.paiement.includes("baridi") ? "/img/custom/baridimob.png" : ""}
    {typeof hit.fields.paiement.includes("ccp") ? "/img/custom/ccp.png" : ""}
