...
<div className="col-lg-4  mb-0 p-0" >
    ...
    <div className="row align-items-center">
      ...
      <div className="card card-blog card-plain">
                ...
                if (screen.width < 767.98){
                    ...
                    }} type="button" className="btn bg-gradient-info btn-lg w-100">Comparer {data?.results.summary.total} offres</button>
...
<div className="col-lg-8 mb-1 p-0" id="results1">
...
<div className='col-lg-2 col-md-3 col-sm-3 col-3 mt-0 ps-0 text-center'>
  <Facets data={data.results}/>
  </div>

 
  <div className='col-lg-5 col-md-5 col-sm-6 col-6 mt-0 text-center'>
  

   <div className="row justify-content-center">
   
      <div className=" col-md-4 col-sm-4 col-5 p-0" >
         <button id="btn-fontsize" type="button"  className={viewType === "Liste" ? "btn bg-gradient-info mb-0 " : "btn mb-0  "} onClick={Liste}  >
         Liste
         </button>
      </div>   
      <div className=" col-md-4 col-sm-4 col-5 p-0" >
         <button id="btn-fontsize" type="button"  className={viewType === "Grille" ? "btn bg-gradient-info mb-0  " : "btn mb-0  "} onClick={Grille} >
         Grille
         </button>
      </div>
...
<div className="col-lg-2 col-md-3 col-sm-3 col-3 mt-0 pe-0 text-center">
...
{data?.results.hits.items.map((hit) => (
  ...
  <div className="modal fade" id={hit.id.replace(/[0-9]/, 'Z')} tabindex="-1" aria-labelledby={hit.id.replace(/[0-9]/, 'Z') + "Label"} aria-hidden="true">
          <div className="modal-dialog" id={hit.id.replace(/[0-9]/, 'Z')} >
          <div className="modal-content">
          <div className="modal-header justify-content-center">


          <a href={hit.fields.shop_website}>
          <img className="img-fluid border-radius-lg " id="img-width" src={hit.fields.vendeurs_image} alt={hit.fields.vendeurs}/>
          </a>
          ...
          <div className="modal fade" id={hit.id.replace(/[0-9]/, 'Z') + "-img"} tabindex="-1" aria-labelledby={hit.id.replace(/[0-9]/, 'Z') + "Label"} aria-hidden="true">
          <div className="modal-dialog" id={hit.id.replace(/[0-9]/, 'Z') + "-img"} >
          <div className="modal-content">
  ...
  <div key={hit.id.replace(/[0-9]/, 'Z')} className="container card shadow-lg ">
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    <h6 className="mt-1 mx-1 mb-0" id="title-style">{hit.fields.product_names}</h6>
    </a>
    </div>
    ...
    <img className="shadow col-lg-6 col-md-6 col-sm-6 col-6" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
    {hit.fields.paiement.toString().includes("Baridimob") ? 
    <img className="shadow col-lg-6 col-md-6 col-sm-6 col-6" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    </div>
    ...
    { hit.fields.livraison != undefined ? hit.fields.livraison.toString().includes(" ") ? <img title="" data-bs-original-title={"Livraison: " + hit.fields.livraison} data-bs-toggle="tooltip" data-bs-placement="top" className="col-lg-12 col-md-12 col-sm-12 col-12" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/shipped-icon-13.jpg"/> : "" : ""}
    ...
    <ul className="dropdown-menu z-index-1"  aria-labelledby={hit.id.replace(/[0-9]/, 'Z')}>
    
          

          <a className="dropdown-item text-bold" href={'tel:' + hit.fields.telephone1} >
          <li >
          <img src="/img/custom/phone-call.svg"/>  Appeler
          </li>
          </a>

          <a className="dropdown-item text-bold" href={hit.fields.localisation} target="_blank">
          <li>
          <img src="/img/custom/map.svg"/> Localisation
          </li>
          </a>

          <a className="dropdown-item text-bold" href={hit.fields.shop_website} target="_blank">
          <li>
          <img src="/img/custom/external-link.svg"/> Voir site
          </li>
          </a>

          <a className="dropdown-item text-bold" style={{cursor: "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z')}>
          <li>
    ...
    <div className="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 text-end ps-lg-1 pe-lg-3 ps-md-1 pe-md-3 ps-sm-1 pe-sm-3 ps-1" >
          ...
          target="_blank"><button type="button" className="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize" data-animation="true">Voir l'offre</button></a>
...
{data?.results.hits.items.map((hit) => (
  ...
  <div key={hit.id.replace(/[0-9]/, 'Z')} className="col-lg-6 col-xl-4 col-md-6 col-sm-6 col-6 mb-2 px-1" >
  <div className="card">
  ...
  <div className="modal fade" id={hit.id.replace(/[0-9]/, 'Z')} tabindex="-1" aria-labelledby={hit.id.replace(/[0-9]/, 'Z') + "Label"} aria-hidden="true">
          ...
          <div className="card-header h-50 p-0 m-2 position-relative z-index-0 justify-content-center row">
            <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"} className="d-block blur-shadow-image">
              <img src={hit.fields.product_imagelinks}  className="img-fluid shadow border-radius-lg w-100" style={{objectFit: "cover", aspectRatio: "1 / 1"}}/>
            </a>
          </div>
    
          <div className="card-body h-50 p-1 m-2">
            <div className="text-bold overflow-title" style={{minHeight: "50px"}}>
            {hit.fields.product_names}
            </div>


            <div className="row justify-content-start text-start">
            <h1 className="text-gradient text-info mb-1 col-8 pe-0" id="state1" id="price-fontsize">{hit.fields.product_prices.replace(/\B(?=(\d{3})+(?!\d))/g, " ")} DA</h1>
            <div className="col-4 row justify-content-center text-start px-1">
            <div className="col-7 p-0" >
            <div title="" data-bs-original-title={"Paiement: " + hit.fields.paiement}  data-bs-toggle="tooltip" data-bs-placement="top">
            {hit.fields.paiement.toString().includes("CCP") ? 
            <img className="shadow col-6" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
            {hit.fields.paiement.toString().includes("Baridimob") ? 
            <img className="shadow col-6" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
            </div>
            ...
            <p className="mb-1" style={{minHeight: "25px"}} id={hit.fields.stocks === 'Rupture de stock' ? "Rupture_de_stock" : "En_stock" }><strong>{hit.fields.stocks}</strong></p>
    ...
    <a data-bs-toggle="dropdown" id={hit.id.replace(/[0-9]/, 'Z') + "drop"} style={{cursor: "pointer"}}>
    <img id="img-width" src={hit.fields.vendeurs_image} alt={hit.fields.vendeurs} className="img-fluid border-radius-lg " style={{maxheight: "20px"}}/>
    </a>
    ...
    <ul className="dropdown-menu z-index-1" aria-labelledby={hit.id.replace(/[0-9]/, 'Z')}>
          ...
          <a className="dropdown-item text-bold" href={'tel:' + hit.fields.telephone1} target="_blank">
          <li >
          <img src="/img/custom/phone-call.svg"/>  Appeler
          </li>
          </a>
          ...
          <a className="dropdown-item text-bold" data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z')}>
          <li>
          <img src="/img/custom/info.svg"/> Détails
          </li>
          </a>
            ...
            <div className="col-md-6 col-sm-6 col-6 p-0 text-center">
            <a href={hit.fields.product_links}  className="text-success icon-move-right titles-size">Voir l'offre
