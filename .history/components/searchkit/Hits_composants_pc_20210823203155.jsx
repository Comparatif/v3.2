...
<div class='col-md-4 col-sm-4 col-4 mt-0 text-center'>
  ...
  <div class="nav-wrapper position-relative end-0">
   <ul class="nav nav-pills nav-fill p-1" role="tablist">
      ...
      <li class="nav-item" >
         <a  class="nav-link mb-0 px-0 py-1" style= {viewType === "Liste" ? {transformer} : {backgroundColor: "white", cursor: "pointer"}} onClick={Liste} data-bs-toggle="tab"  role="tab" aria-controls="profile" aria-selected="true">
         Liste
         </a>
      </li>
