...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <div key={cle} class="col-lg-2 col-xl-2 col-md-2 col-sm-2 col-2 mb-2 px-1" >
  <div class="card">
  ...
  <div class="modal fade" id={cle} tabindex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
          ...
          <div class="card-body h-50 p-1 m-2">
            <a target="_blank" rel="noreferrer" href={product_links} class="text-bold overflow-title" style={{minHeight: "25px"}}>
