...
{data?.results.hits.items.map((hit) => {
    ...
    const description1 = hit.fields.
    const brand_name = hit.fields.
    const description2 = hit.fields.
    const prod_description = hit.fields.
    const prod_specs_big_title = hit.fields.
    const total = hit.fields.
