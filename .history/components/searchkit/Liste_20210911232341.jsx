...
useEffect(()=> 
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <div style={{width: '75px'}} class="row justify-content-center text-center p-0" onClick={() => SetCanvas(`SignUp-form-${cle}`)}>
       

  
    <div class="row justify-content-center text-center p-0" >
  
    <div style={{width: '75px'}} class="p-0"><AverageStars votesLoading={votesLoading}
