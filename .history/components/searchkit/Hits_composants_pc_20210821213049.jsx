...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <ul class="dropdown-menu" aria-labelledby={hit.id}>
          ...
          <button type="button" class="btn bg-gradient-info mb-0" data-bs-toggle="modal" data-bs-target={"#" + hit.id.toString()}>A propos</button>
          <div class="modal fade" id={hit.id.toString()} tabindex="-1" aria-labelledby={hit.id.toString() + "Label"} aria-hidden="true">
          <div class="modal-dialog" id="modal-dialog">
          <div class="modal-content">
          <div class="modal-header">

          <h6 class="modal-title" id={hit.id.toString() + "Label"}>Le comparateur de prix qu'il manquait a l'Algérie..</h6>
