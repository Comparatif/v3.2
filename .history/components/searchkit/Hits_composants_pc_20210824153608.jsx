...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {typeof hit.fields.paiement.indexOf("Baridimob") >=0 ? <img class="w-25" src="/img/custom/baridimob.png"/> : "cvbc"}
    {typeof hit.fields.paiement.indexOf("CCP") >=0 ? <img class="w-25" src="/img/custom/ccp.png"/> : "vhv"}
