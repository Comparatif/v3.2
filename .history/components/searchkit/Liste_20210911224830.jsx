...
useEffect(()=> 
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <div class="col-12 p-0"><AverageStars votesLoading={votesLoading}
    StarRating={StarRating} ListeNotesBoutique={ListeNotesBoutique}  
    cle={cle} CanvasState={CanvasState} size={15} className={"col-12 p-0 justify-content-center row"} style={{left: '50%', marginLeft: '-31.250px', left: '50%', marginLeft: '-31.250px'}}/>
    </div>
    </div>
