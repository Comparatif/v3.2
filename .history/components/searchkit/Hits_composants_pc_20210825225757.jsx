...
{data?.results.hits.items.map((hit) => (
  ...
  <div key={hit.id.replace(/[0-9]/, 'Z')} class="col-lg-4 col-md-6 col-sm-6 col-6 mb-2 px-1" >
  <div class="card">
  ...
  <div class="modal fade" id={hit.id.replace(/[0-9]/, 'Z')} tabindex="-1" aria-labelledby={hit.id.replace(/[0-9]/, 'Z') + "Label"} aria-hidden="true">
          ...
          <div class="card-header h-50 p-0 mx-2 position-relative z-index-0 justify-content-center row">
          ...
          <div class="card-body h-50 p-1 mx-2">
