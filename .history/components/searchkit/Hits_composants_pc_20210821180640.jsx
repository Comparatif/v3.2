  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <ul class="dropdown-menu no-overflow" aria-labelledby={hit.id}>
      ...
      <ul class="sub-filters">
          <a class="dropdown-item btn bg-gradient-info" href="#">
          Détails
          </a>
      
          <a class="dropdown-item btn bg-gradient-success" href="#">
          Appeler
          </a>
          </li>
          ...
          <a class="dropdown-item btn bg-gradient-warning" href="#">
          Localisation
          </a>

          <a class="dropdown-item btn bg-gradient-default" href="#">
          Voir site
          </a>
