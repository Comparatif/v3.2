...
const lesDescriptions = description_data?.description.hits.items

  const description1 = description_data?.description.hits.items.slice(0,1).map((hit)=>hit.fields.description1)
  const brand_name = description_data?.description.hits.items.slice(0,1).map((hit)=>hit.fields.brand_name)
  const description2 = description_data?.description.hits.items.slice(0,1).map((hit)=>hit.fields.description2)
  const prod_description = description_data?.description.hits.items.slice(0,1).map((hit)=>hit.fields.prod_description)
  const prod_specs_big_title = description_data?.description.hits.items.slice(0,1).map((hit)=>hit.fields.prod_specs_big_title)
  const total = description_data?.description.hits.items.slice(0,1).map((hit)=>hit.fields.total)
