...
export const Listes = ({ data, boutique_infos, votesLoading, user, datetime, CanvasState, SetCanvas, isOn, toggleIsOn }) => {
  ...
  const imgWidth = { width: '100%', maxHeight: '40px'}
  const imgWidthBlur = { width: '100%', maxHeight: '40px', filter: "blur(1rem)", width: "60%"}
  const productCountryCss = {width: "8%", height: "8%", borderRadius: "1px", boxShadow: "1px 1px 2px black"}
...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <div class="modal fade" id={cle} tabindex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
          ...
          <a href={shop_website}>
          <Image class="img-fluid border-radius-lg " style={imgWidth}  src={vendeurs_image} alt={vendeurs}/>
          </a>
          
          
          </div>
          <div class="modal-body text-left">
          <strong>Pays :</strong>  {product_country} <Image src={product_country == "Algérie" ? "/img/custom/2634506_algeria_ensign_flag_nation_icon.png" : "" } style={productCountryCss}/><br/>
          ...
          <Image src="/img/custom/317727_facebook_social media_social_icon.png" style={{width: "8%", height: "8%", borderRadius: "30px"}}/></a> 

          <a href={instagram} target="_blank">
          <Image style={{width: "8%", height: "8%", borderRadius: "1px"}} src="/img/custom/3225191_app_instagram_logo_media_popular_icon.png"/></a>
          ...
          <Image style= {w75} src={product_imagelinks} />
          </div>
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <Image  style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
    {paiement?.toString().includes("aridi") ? 
    <Image  style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    {paiement?.toString().includes("paypal") ? 
    <Image  style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="Paypal" src="/img/custom/1156727_finance_payment_paypal_icon.png"/> : ""}
    {paiement?.toString().includes("visa") ? 
    <Image  style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="visa" src="/img/custom/206684_visa_method_card_payment_icon.png"/> : ""}
    {paiement?.toString().includes("CIB") ? 
    <Image  style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="CIB" src="/img/custom/CIB.png"/> : ""}
    {paiement?.toString().includes("DAHABIA") ? 
    <Image  style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"33%"}} alt="dahabia" src="/img/custom/edahabia_gold-300x190.png"/> : ""}
    </div>
    ...
    { livraison != undefined ? livraison?.toString().includes("UPS") ? <Image title="" data-bs-original-title={"Livraison: " + livraison} data-bs-toggle="tooltip" data-bs-placement="top" class="col-lg-12 col-md-12 col-sm-12 col-12" style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"75%"}} alt= {"Livraison -" + livraison} src="/img/custom/UPS-Icon.png"/>: "" : ""}
    { livraison != undefined ? livraison?.toString().includes("FEDEX") ? <Image title="" data-bs-original-title={"Livraison: " + livraison} data-bs-toggle="tooltip" data-bs-placement="top" class="col-lg-12 col-md-12 col-sm-12 col-12" style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"75%"}} alt= {"Livraison -" + livraison} src="/img/custom/logo-FedEx-1.jpg"/>: "" : ""}
    { livraison != undefined ? livraison?.toString().includes("isponible") || livraison?.toString().includes("territoire national") || livraison?.toString().includes("Toutes les wilaya")
     ? <Image title="" data-bs-original-title={"Livraison: " + livraison} data-bs-toggle="tooltip" data-bs-placement="top" class="col-lg-12 col-md-12 col-sm-12 col-12" style={{width: 'auto', objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"75%"}} alt= {"Livraison -" + livraison} src="/img/custom/shipped-icon-13.jpg"/>: "" : ""}
    ...
    <Image style={imgWidth} src={vendeurs_image} alt={vendeurs} class="img-fluid border-radius-lg"/>
    </a>
    ...
    <ul class="dropdown-menu z-index-1"  aria-labelledby={cle}>
          ...
          <li >
          <Image style = {{ width: 'auto', height: 'auto' }} src="/img/custom/phone-call.svg"/>  Appeler
          </li>
          </a>

          <a class="dropdown-item text-bold" href={localisation} target="_blank">
          <li>
          <Image style = {{ width: 'auto', height: 'auto' }} src="/img/custom/map.svg"/> Localisation
          </li>
          </a>

          <a class="dropdown-item text-bold" href={shop_website} target="_blank">
          <li>
          <Image style = {{ width: 'auto', height: 'auto' }} src="/img/custom/external-link.svg"/> Voir site
          </li>
          </a>

          <a class="dropdown-item text-bold" style={{cursor: "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle}>
          <li>
          <Image style = {{ width: 'auto', height: 'auto' }} src="/img/custom/info.svg"/> Détails
          </li>
          </a>     
  </ul>
...
/>
  <Auth cle={cle} CanvasState={CanvasState}  user={user}/>
    ...
    <Image style={imgWidthBlur} src="/blur/4.jpg"  class="img-fluid border-radius-lg" />
    </a>
