...
{data?.results.hits.items.map((hit) => {
    ...
    const resetExistence = async () => {
    
      
        SetOrderContext({...OrderContext, isOrderTaken: false, hit: hit, boutique:vendeurs, product_name: product_names})
...
{enableOrder ? 
  ...
  <a onClick={user ? doesOrderExist : null} data-bs-toggle="modal" data-bs-target="#modal-form-order"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize" data-animation="true">Acheter</button></a>
