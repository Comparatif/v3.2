...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          ...
          <strong>Pays </strong>: <img src={hit.fields.product_country == "Algérie" ? "/img/custom/2634506_algeria_ensign_flag_nation_icon.png" : "" } style={{width: "8%", height: "8%", borderRadius: "1px", boxShadow: "1px 1px 1px black"}}></img> {hit.fields.product_country} <br/>
