...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <div key={cle} className="col-lg-2 col-xl-2 col-md-2 col-sm-2 col-2 mb-2 px-1" >
  <div className="card">
  ...
  <div className="modal fade" id={cle} tabIndex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
          ...
          <div className="card-body h-50 p-1 m-2">
            <a target="_blank" rel="noreferrer" href={product_links} className="text-bold overflow-title" style={{minHeight: "25px"}}>
