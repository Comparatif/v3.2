...
export const HitsList = ({ data }) => {
  ...
  const transformer = {padding: "0px", cursor: "pointer", transition: "all 0.5s ease 0s", transform: "translate3d(0px, 0px, 0px)", width: "49%"} : {padding: "0px", transition: "all 0.5s ease 0s", transform: "translate3d(0px, 0px, 0px)", width: "49%"}
