...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <img class="w-25" src={typeof hit.fields.paiement.includes("sthrgrdxfrh") ? "/img/custom/ccp.png" : ""}/>
    <img class="w-25" src={typeof hit.fields.paiement.includes("hstfgrdxfh") ? "/img/custom/baridimob.png" : ""}/>
