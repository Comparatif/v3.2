...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 p-1 px-lg-3" >
    ...
    <div class="col-lg-1 col-md-1 col-sm-1 col-1 mb-1 ps-1 p-1 px-lg-3" >
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-4 mb-1 text-end ps-1 pe-3" >
