  ...
  <div class="px-sm-0">
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <Markup content={prod_description?.replace("<h2>", "<h2 class='title-fontsize-h2'>").replace("<h3>", "<h3 class='title-fontsize-h2'>").replace("<p>", "<p style={{textAlign: 'justify'; text-justify: 'inter-word'}}>")} />
