...
{data?.results.hits.items.map((hit) => {
    ...
    const doesOrderExist = async ({orderId}) => {
...
{enableOrder ? 
  ...
  <a onClick={user ? doesOrderExist({orderId}) : null} data-bs-toggle="modal" data-bs-target="#modal-form-order"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize" data-animation="true">Acheter</button></a>
