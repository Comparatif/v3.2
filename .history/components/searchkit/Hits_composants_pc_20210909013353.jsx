...
useEffect(() => {
  ...
  var tooltipList = tooltipTriggerList.map( function (tooltipTriggerEl) {
    tooltipTriggerEl.addEventListener('mouseover','mouseleave', function () {return new bootstrap.Tooltip(tooltipTriggerEl, {trigger: "manual"})})
    return new bootstrap.Tooltip(tooltipTriggerEl, {trigger: "manual"}).show()
