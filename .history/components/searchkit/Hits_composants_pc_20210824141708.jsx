...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 pe-1" >
      ...
      <p class="ms-1 text-small" ><strong class="text-small">{hit.fields.paiement}</strong></p>
    </div>
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 pe-1" >
    
      <p class="ms-1 text-small" ><strong class="text-small">{hit.fields.livraison}</strong></p>
    </div>
