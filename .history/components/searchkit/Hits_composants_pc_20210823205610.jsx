  ...
  <div class="nav-wrapper position-relative end-0">
   ...
   <div class="container p-0"><div class="row justify-content-center">
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 pe-1" >
         <button type="button"  class={viewType === "Liste" ? "nav-link btn bg-gradient-info mb-0 px-0 py-1" : "btn nav-link mb-0 px-0 py-1"} onClick={Liste}  >
         Liste
         </button>
      </li>
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 ps-1" >
         <button type="button"  class={viewType === "Grille" ? "nav-link btn bg-gradient-info mb-0 px-0 py-1" : "btn nav-link mb-0 px-0 py-1"} onClick={Grille} >
         Grille
         </button>
      </li>
