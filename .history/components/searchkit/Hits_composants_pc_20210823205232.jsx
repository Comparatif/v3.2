...
export const HitsList = ({ data }) => {
  ...
  const transformer = { cursor: "pointer", backgroundColor:"blue"} 
...
<div class='col-md-4 col-sm-4 col-4 mt-0 text-center'>
  ...
  <div class="nav-wrapper position-relative end-0">
   ...
   <div class="container p-0"><div class="row justify-content-center">
   
      <li class="nav-item col-md-6 col-sm-6 col-6 pe-1" >
         <a  class="nav-link btn bg-gradient-info mb-0 px-0 py-1" class={viewType === "Liste" ? "nav-link btn bg-gradient-info mb-0 px-0 py-1" : "nav-link mb-0 px-0 py-1"} onClick={Liste} data-bs-toggle="tab"  role="tab" aria-controls="profile" >
         Liste
         </a>
      </li>
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 ps-1" >
         <a  class="nav-link mb-0 px-0 py-1" class={viewType === "Liste" ? "nav-link btn bg-gradient-info mb-0 px-0 py-1" : "nav-link mb-0 px-0 py-1"} onClick={Grille} data-bs-toggle="tab"  role="tab" aria-controls="dashboard" >
         Grille
         </a>
      </li>
