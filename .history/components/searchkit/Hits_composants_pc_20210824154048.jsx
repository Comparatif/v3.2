...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {JSON.stringify(hit.fields.paiement).includes("Baridimob") >=0 ? "/img/custom/baridimob.png" : "1"}
    {JSON.stringify(hit.fields.paiement).includes("CCP") >=0 ? <img class="w-25" src="/img/custom/ccp.png"/> : "2"}
