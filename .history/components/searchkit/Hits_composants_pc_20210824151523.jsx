...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {()=> {if (hit.fields.paiement.includes("baridi")) { return ( <img class="w-25" src="/img/custom/baridimob.png"/> )}}}
    {typeof hit.fields.paiement.includes("baridi") ? <img class="w-25" src="/img/custom/baridimob.png"/> : ""}
    {typeof hit.fields.paiement.includes("ccp") ? <img class="w-25" src="/img/custom/ccp.png"/> : ""}
