...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {hit.fields.paiement.value.indexOf("baridi") ? <img class="w-25" src="/img/custom/baridimob.png"/> : ""}
    {hit.fields.paiement.value.indexOf("ccp") ? <img class="w-25" src="/img/custom/ccp.png"/> : ""}
