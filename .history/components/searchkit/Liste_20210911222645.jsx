...
useEffect(()=> 
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <img class="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"50%"}} alt="Paypal" src="/img/custom/206684_visa_method_card_payment_icon.png"/> : ""}
    {paiement.toString().includes("CIB") ? 
    <img class="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"50%"}} alt="Paypal" src="/img/custom/CIB.png"/> : ""}
    </div>
    ...
    <div class="row justify-content-center text-center col-12" onClick={() => SetCanvas(`SignUp-form-${cle}`)}>
       

    <div class="col-xl-2 row justify-content-center text-center p-0" ><small>{StarRating}</small></div>
    <div class="col-xl-10 row justify-content-center text-center  px-xl-1" >
    <AverageStars votesLoading={votesLoading}
    StarRating={StarRating} ListeNotesBoutique={ListeNotesBoutique}  
    cle={cle} CanvasState={CanvasState} size={18} className={styles.center} />
    </div>
