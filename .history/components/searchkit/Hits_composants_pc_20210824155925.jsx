...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {hit.fields.paiement  ? "/img/custom/baridimob.png" : "1"}
    {hit.fields.paiement  ? <img class="w-25" src="/img/custom/ccp.png"/> : "2"}
      <p class="ms-1" ><strong class="text-small">{hit.fields.paiement.toString()}</strong></p>
    </div>
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 pe-1" >
