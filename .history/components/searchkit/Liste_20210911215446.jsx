...
useEffect(()=> 
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <img class="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    {paiement.toString().includes("paypal") ? 
    <img class="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Paypal" src="/img/custom/1156727_finance_payment_paypal_icon.png"/> : ""}
