...
// Use like:
  ...
  var element_test = document.getElementsByClassName("tooltip fade show bs-tooltip-bottom")[0]
...
tooltipList.forEach((e)=> e.disable()) && removeElements( document.querySelectorAll("tooltip fade show bs-tooltip-bottom") );
