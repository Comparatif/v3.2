...
<div class="col-lg-4 col-md-4 col-sm-4 col-4 mb-0 p-0" >
...
<div class="col-lg-8 col-md-8 col-sm-8 col-8 mb-1 p-0" id="results1">
...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-4 mb-1 pe-1" >
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 p-1 px-lg-4" >
    ...
    <div class="col-lg-1 col-md-1 col-sm-1 col-1 mb-1 ps-1 p-1 px-lg-2" >
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 p-1 px-lg-4"  >
    <div class="dropdown">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-4 mb-1 text-end ps-lg-1 pe-lg-3  " >
