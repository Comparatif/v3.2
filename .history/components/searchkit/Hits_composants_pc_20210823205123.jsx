  ...
  <div class="nav-wrapper position-relative end-0">
   ...
   <div class="container p-0"><div class="row justify-content-center">
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 pe-1" >
         <a  class="nav-link btn bg-gradient-info mb-0 px-0 py-1" class= {viewType === "Liste" ? transformer : {backgroundColor: "white", cursor: "pointer"}} onClick={Liste} data-bs-toggle="tab"  role="tab" aria-controls="profile" >
         Liste
         </a>
      </li>
