    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <div class="card-body px-1 pt-3 pb-0">
                  ...
                  <button class="btn bg-gradient-info btn-lg w-50 py-2 px-1 " onClick={toggleIsOn2} >{isOn2 ? 'Description' : 'Spécifications'}
                  <img src="/img/custom/info.svg" class={IsComposantsSelected ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right"/></button>
                  <button onClick={() => {
