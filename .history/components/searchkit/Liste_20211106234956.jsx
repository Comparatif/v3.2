...
export const Listes = ({ data, boutique_infos, votesLoading, user, datetime, isOn, toggleIsOn }) => {
...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    <h2 class="mt-1 mx-1 mb-0 title-fontsize-h2" id="title-style">{product_names} - {villes1}</h2> 
    </a>
    </div>
