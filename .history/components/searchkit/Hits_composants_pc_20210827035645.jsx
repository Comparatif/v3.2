...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-toggle="tooltip" data-bs-placement="right"{"Paiement: " + hit.fields.paiement}>
