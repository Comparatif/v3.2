...
const lesDescriptions =  data?.description.hits.items.slice(0,1).map(
  ...
  console.log({a: hit.fields.description1, b: hit.fields.brand_name, c: hit.fields.description2, d: hit.fields.prod_description,
    e: hit.fields.prod_specs_big_title, f: hit.fields.total})
  

  )


  const description1 = lesDescriptions.a
  const brand_name = lesDescriptions.b
  const description2 = lesDescriptions.c
  const prod_description = lesDescriptions.d
  const prod_specs_big_title = lesDescriptions.e
  const total = lesDescriptions.f
