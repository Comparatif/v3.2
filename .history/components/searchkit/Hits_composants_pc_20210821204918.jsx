...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <ul class="dropdown-menu" aria-labelledby={hit.id}>
          ...
          <button type="button" class="btn bg-gradient-info mb-0" data-bs-toggle={hit.id} data-bs-target={"#" + hit.id}>A propos</button>
          <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          <div class="modal-dialog" id="modal-dialog">
          <div class="modal-content">
          <div class="modal-header">

          <h6 class="modal-title" id={hit.id + "Label"}>Le comparateur de prix qu'il manquait a l'Algérie..</h6>
          <button type="button" class="btn-close" data-bs-dismiss={hit.id} aria-label="Close"></button>
          </div>
          ...
          <button type="button" class="btn bg-gradient-info" data-bs-dismiss={hit.id}>J'ai compris</button>
          </div>
          </div>
          </div>
          </div>
