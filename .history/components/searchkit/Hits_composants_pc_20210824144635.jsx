...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 pe-1 w-25 h-25" >
    {hit.fields.paiement.indexOf("baridi") ? <img src="/img/custom/baridimob.png"/> : ""}
    {hit.fields.paiement.indexOf("ccp") ? <img src="/img/custom/ccp.png"/> : ""}
