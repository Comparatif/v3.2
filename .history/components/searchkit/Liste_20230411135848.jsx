...
<div  className="col-lg-12 col-md-12 col-sm-12 col-12 mb-1 text-end ps-lg-1 pe-lg-1 ps-md-1 pe-md-1 ps-sm-1 pe-sm-1 ps-1">
  ...
  <a onClick={enableOrderdoesOrderExist} data-bs-toggle="modal" data-bs-target="#modal-form-order"><button type="button" className="btn bg-gradient-success mb-0 position-relative z-index-0 button-width" id="btn-fontsize-product" data-animation="true" disabled={true}>Acheter</button></a>
