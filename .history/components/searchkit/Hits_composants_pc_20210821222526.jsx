...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          ...
          <img class="img-fluid border-radius-lg w-50" id="img-width" src={hit.fields.vendeurs_image} alt={hit.fields.vendeurs}/>
          
          
          </div>
          <div class="modal-body text-left">
          Pays : {hit.fields.product_country} <br/>
          Villes : {hit.fields.villes1} <br/>
          Commune : {hit.fields.commune} <br/>
          Adresse : {hit.fields.adresses} <br/>
          Contact : {hit.fields.email} <br/>
          Modes de paiement : {hit.fields.paiement} <br/>
          Livraison : {hit.fields.livraison} <br/>
          Heures d'ouvertures : {hit.fields.horaires} <br/>

          Réseau sociaux : {hit.fields.facebook} {hit.fields.instagram} 
          ...
          <button type="button" class="btn bg-gradient-info" data-bs-dismiss="modal">C'est bon</button>
          </div>
          </div>
          </div>
          </div>
