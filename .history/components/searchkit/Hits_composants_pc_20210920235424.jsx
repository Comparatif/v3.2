    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <div class="card-body px-1 pt-3 pb-0">
                  ...
                  <button class="btn bg-gradient-info btn-lg w-50 py-2 px-1 " onClick={toggleIsOn2} >{isOn2 ? 'Description' && <img src="/img/custom/info.svg" title="" data-bs-original-title="Beta : la description peut ne pas correspondre a la recherche dans certains cas."   data-bs-toggle="tooltip" data-bs-placement="left"/>
                  : 'Spécifications' && <img src="/img/custom/info.svg" title="" data-bs-original-title="Beta : la description peut ne pas correspondre a la recherche dans certains cas."   data-bs-toggle="tooltip" data-bs-placement="left"/>}
                  </button>
                  <button onClick={() => {
...
<div class="description">
                 ...
                 <td  dangerouslySetInnerHTML={{__html: prod_description
                  .replace("<h2>", "<h2 class='title-fontsize-h2'")
