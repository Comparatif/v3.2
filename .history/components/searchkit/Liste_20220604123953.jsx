...
{enableOrder ? 
  ...
  <a onClick={user ? doesOrderExist : null} data-bs-toggle="modal" data-bs-target={!user ? "#modal-form-login" : "#modal-form-order"}><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize" data-animation="true">Acheter</button></a>
