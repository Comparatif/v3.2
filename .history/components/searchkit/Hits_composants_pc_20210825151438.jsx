...
<div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 mt-1 px-sm-2 px-md-2 px-lg-2 text-start " ><h6 class="m-0">Paiement</h6></div>
<div class="col-lg-2 col-md-2 col-sm-2 col-1 mb-1 mt-1 ps-1 px-sm-2 px-md-2 px-lg-1 text-start" ><h6 class="m-0">Livraison</h6></div>
<div class="col-lg-2 col-md-2 col-sm-2 col-3 mb-1 mt-1 px-sm-0 px-md-0 px-lg-0 text-start"  ><h6 class="m-0">Marchand</h6></div>
