...
<div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 mt-1 pe-1" >12345</div>
<div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 mt-1 px-md-4 px-lg-4" >12345</div>
<div class="col-lg-1 col-md-1 col-sm-1 col-1 mb-1 mt-1 ps-1 px-md-2 px-lg-2" >12345</div>
<div class="col-lg-3 col-md-3 col-sm-3 col-20-v mb-1 mt-1 px-md-4 px-lg-4"  >12345</div>
<div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 text-end mt-1 ps-lg-1 pe-lg-3 ps-md-1 pe-md-3 ps-sm-1 pe-sm-3 px-1" >12345</div>
</div>
</div>
</section>
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-30-v mb-1 pe-1" >
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 p-1 px-md-4 px-lg-4" >
    <div data-tip={"Paiement: " + hit.fields.paiement}>
    ...
    <div class="col-lg-1 col-md-1 col-sm-1 col-1 mb-1 ps-1 p-1 px-md-2 px-lg-2" >
    { hit.fields.livraison != undefined ? hit.fields.livraison.toString().includes(" ") ? <img data-tip={"Livraison: " + hit.fields.livraison} class="col-lg-12 col-md-12 col-sm-12 col-12" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/shipped-icon-13.jpg"/> : "" : ""}
    <ReactTooltip />
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-20-v mb-1 p-1 px-md-4 px-lg-4"  >
    <div class="dropdown">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 text-end ps-lg-1 pe-lg-3 ps-md-1 pe-md-3 ps-sm-1 pe-sm-3 px-1" >
