    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                if (screen.width < 767.98){
                    ...
                    }} type="button" class="btn bg-gradient-info btn-lg w-50 py-1 px-1">Comparer {data?.results.summary.total} offres</button>
                  
                  <div class="row justify-content-center text-center">
                  <div class="col-6">
                  <button class="btn bg-gradient-info " onClick={toggleIsOn2}>{isOn2 ? 'Description' : 'Spécifications'}</button>
                  </div>
