...
CanvasState == "Off" ?  tooltipList.forEach((e)=> e.enable()) : tooltipList.forEach((e)=> e.disable())
...
useEffect(()=> 
  
  {
    ...
    var testmodal = document.getElementById("tooltip-" + hit.id)
    var testcanvas = document.getElementById("SignUp-form-" + hit.id)
    testcanvas?.addEventListener('show.bs.offcanvas', function (event) {
      return new bootstrap.Tooltip(testmodal).dispose()
    })
