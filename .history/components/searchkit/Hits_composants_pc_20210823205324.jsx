  ...
  <div class="nav-wrapper position-relative end-0">
   ...
   <div class="container p-0"><div class="row justify-content-center">
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 ps-1" >
         <a   class={viewType === "Grille" ? "nav-link bg-gradient-info mb-0 px-0 py-1" : "nav-link mb-0 px-0 py-1"} onClick={Grille} data-bs-toggle="tab"  role="tab" aria-controls="dashboard" >
         Grille
         </a>
      </li>
