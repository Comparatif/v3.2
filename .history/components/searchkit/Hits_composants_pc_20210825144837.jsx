...
<div class="row justify-content-center" id="container-margin-padding">
<div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 mt-1 pe-1 text-small text-center" >Prix & Stock</div>
<div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 mt-1 px-md-4 px-lg-4 text-center " >Méthodes de paiement</div>
<div class="col-lg-1 col-md-1 col-sm-1 col-1 mb-1 mt-1 ps-1 px-md-2 px-lg-2 text-center" >Livraison</div>
<div class="col-lg-3 col-md-3 col-sm-3 col-2 mb-1 mt-1 px-md-4 px-lg-4 text-center"  >Marchand</div>
<div class="col-lg-3 col-md-3 col-sm-3 col-2 mb-1 text-end mt-1 ps-lg-1 pe-lg-3 ps-md-1 pe-md-3 ps-sm-1 pe-sm-3 ps-1 text-center" >12345</div>
</div>
</div>
</section>
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 p-1 px-md-4 px-lg-4"  >
    <div class="dropdown">
