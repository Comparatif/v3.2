...
const visibilite_desc = isOn2 === false ? "visible" : "hidden"
const visibilite_specs = isOn2 === true ? "visible" : "hidden"
    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <a class="text-center">
                    ...
                    {!names_bdd ? product_names : names_bdd } - Prix Algérie
                ...
                (<div style={{textAlign: 'justify', textJustify: 'inter-word'}} class="description-custom">
                  ...
                  <p class="small mb-0 top-0 position-relative" style={{whiteSpace: 'pre-wrap', visibility: visibilite_desc}}>
                ...
                <Markup content={prod_description?.replace("<h2>", "<h2 class='title-fontsize-h2'>").replace("<h3>", "<h3 class='title-fontsize-h2'>")} />
                 ...
                 <p class="small mb-0 top-0 position-absolute" style={{whiteSpace: 'pre-wrap', visibility: visibilite_specs}}>
                 {total}
                 </p>
