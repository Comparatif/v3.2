    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                if (screen.width < 767.98){
                  ...
                  <div class="col-4">
                  <button class="btn bg-gradient-info btn-lg w-100">Description</button>
                  </div>
                  <div class="col-4">
                  <button class="btn bg-gradient-info btn-lg w-100">Caractéristiques</button>
                  </div>
                  <div class="col-4">
                  <button class="btn bg-gradient-info btn-lg w-100"></button>
                  </div>
                  </div>
                    <p class="small mb-0">
                  {description1}</p>
                ...
                <p class="small mb-0">
                 ...
                 <p class="small mb-0">
                 <td dangerouslySetInnerHTML={{__html: prod_description}} /></p>
