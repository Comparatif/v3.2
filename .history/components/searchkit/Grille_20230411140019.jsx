...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <div className="modal fade" id={cle} tabIndex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
    ...
    <ul className="dropdown-menu z-index-1" aria-labelledby={cle}>
        ...
        <a onClick={import { showShop, enableOrder, legendaires, epiques, rares } from '../../lib/Options'
doesOrderExist} data-bs-toggle="modal" data-bs-target="#modal-form-order"><button type="button" className="btn bg-gradient-success mb-0 position-relative z-index-0 button-width" id="btn-fontsize-product" data-animation="true" disabled={true}>Acheter</button></a>
