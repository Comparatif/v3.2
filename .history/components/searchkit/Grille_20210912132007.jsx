...
const type = hit.fields.type
  ...
  <div class="modal fade" id={cle} tabindex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
    ...
    <img class="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"35%"}} alt="Paypal" src="/img/custom/206684_visa_method_card_payment_icon.png"/> : ""}
    {paiement.toString().includes("CIB") ? 
    <img class="shadow" style={{objectFit: "scale-down", aspectRatio: "1 / 1", maxWidth:"35%"}} alt="Paypal" src="/img/custom/CIB.png"/> : ""}
    </div>
