...
const lesDescriptions = () => description_data?.description.hits.items.slice(0,1).map(
  ...
  [console.log(hit.fields.description1), hit.fields.brand_name, hit.fields.description2,hit.fields.prod_description,
  ...
  const total = lesDescriptions[5]

console.log(description1)

const lesDescriptionsl = () => description_data?.description.hits.items.slice(0,1).map(
  (hit)=>

  console.log(hit.fields.description1)
  )
  /***************FireStore***********************/
// Time
