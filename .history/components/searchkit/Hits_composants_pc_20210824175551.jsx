...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {hit.fields.paiement.toString().includes("Baridimob") ? <img class="shadow col-lg-6 col-md-6 col-sm-6 col-3" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
