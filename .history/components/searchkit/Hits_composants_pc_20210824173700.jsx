...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    <div class="col-lg-3 col-md-2 col-sm-2 col-2 mb-1 pe-1" >
    {hit.fields.paiement.toString().includes("CCP") ? <img class="shadow col-lg-4 col-md-4 col-sm-4 col-4" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
    {hit.fields.paiement.toString().includes("Baridimob") ? <img class="shadow col-lg-4 col-md-4 col-sm-4 col-4" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    
      
    </div>
    <div class="col-lg-1 col-md-2 col-sm-2 col-2 mb-1 ps-1" >
    
    { hit.fields.livraison != undefined ? hit.fields.livraison.toString().includes(" ") ? <img  style={{width: "100%", objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/shipped-icon-13.jpg"/> : "" : ""}
