...
const lesDescriptions =  data?.description?.hits?.items?.slice(0,1).map(
  ...
  {hit.fields.description1, hit.fields.brand_name, hit.fields.description2, hit.fields.prod_description,
    e: hit.fields.prod_specs_big_title, hit.fields.total, g: hit.fields.product_names}
  

  )

  const description1 = lesDescriptions[0]?.a
  const brand_name = lesDescriptions[0]?.b
  const description2 = lesDescriptions[0]?.c
  const prod_description = lesDescriptions[0]?.d
  const prod_specs_big_title = lesDescriptions[0]?.e
  const total = lesDescriptions[0]?.f
  const names_bdd = lesDescriptions[0]?.g
    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <a class="text-center">
                    ...
                    {names_bdd || product_names} - Prix Algérie
