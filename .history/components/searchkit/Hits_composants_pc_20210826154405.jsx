...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id.replace(/[0-9]/, 'Z')} tabindex="-1" aria-labelledby={hit.id.replace(/[0-9]/, 'Z') + "Label"} aria-hidden="true">
          ...
          <div class="card-body h-50 p-1 m-2">
            ...
            <h1 class="text-gradient text-info mb-1 col-7 pe-0" id="state1" id="price-fontsize">{hit.fields.product_prices.replace(/\B(?=(\d{3})+(?!\d))/g, " ")} DA</h1>
            <div class="col-3 mb-1 p-1 px-md-4 px-lg-4" >
            <div data-tip={"Paiement: " + hit.fields.paiement}>
            {hit.fields.paiement.toString().includes("CCP") ? 
            ...
            <div class=" col-1 mb-1 ps-1 p-1 px-md-2 px-lg-2" >
            { hit.fields.livraison != undefined ? hit.fields.livraison.toString().includes(" ") ? <img data-tip={"Livraison: " + hit.fields.livraison} class="col-lg-12 col-md-12 col-sm-12 col-12" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/shipped-icon-13.jpg"/> : "" : ""}
            <ReactTooltip />
