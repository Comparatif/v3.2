...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <ul class="dropdown-menu no-overflow" aria-labelledby={hit.id}>
          ...
          <a class="dropdown-item text-bold" href={hit.fields.localisation}>
          <li>
          <img src="/img/custom/map.svg"/> Localisation
          </li>
          </a>

          <a class="dropdown-item text-bold" href={hit.fields.shop_website}>
          <li>
          <img src="/img/custom/external-link.svg"/> Voir site
          </li>
          </a>

          <a class="dropdown-item text-bold" href="#">
          <li>
