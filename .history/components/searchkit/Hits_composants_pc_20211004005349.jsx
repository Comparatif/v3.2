...
const lesDescriptions = () => data?.description.hits.items.map(
  ...
  {return([console.log(hit.fields.description1), hit.fields.brand_name, hit.fields.description2,hit.fields.prod_description,
...
data?.description.hits.items.slice(0,1).map((hit)=>console.log(hit.fields.description1))
  /***************FireStore***********************/
// Time
