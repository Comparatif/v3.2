...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id.replace("_", "-")} tabindex="-1" aria-labelledby={hit.id.replace("_", "-") + "Label"} aria-hidden="true">
          <div class="modal-dialog" id={hit.id.replace("_", "-")} >
          ...
          <div class="modal fade" id={hit.id.replace("_", "-") + "-img"} tabindex="-1" aria-labelledby={hit.id.replace("_", "-") + "Label"} aria-hidden="true">
          <div class="modal-dialog" id={hit.id.replace("_", "-") + "-img"} >
          <div class="modal-content">
  ...
  <div key={hit.id.replace("_", "-")} class="container card shadow-lg ">
  
  <div class="row justify-content-center text-start" id="container-margin-padding">
  
  <div class="col-md-12 col-sm-12 col-12">
  
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace("_", "-") + "-img"}>
    ...
    <a data-bs-toggle="dropdown" id={hit.id.replace("_", "-") + "drop"} style={{cursor: "pointer"}}>
    <img id="img-width" src={hit.fields.vendeurs_image} alt={hit.fields.vendeurs} class="img-fluid border-radius-lg" />
    </a>

    <ul class="dropdown-menu z-index-1" aria-labelledby={hit.id.replace("_", "-")}>
          ...
          <a class="dropdown-item text-bold" data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace("_", "-")}>
          <li>
...
{data?.results.hits.items.map((hit) => (
  ...
  <div key={hit.id.replace("_", "-")} class="card col-md-4 col-sm-4 col-4 mb-1" id="info-produit1">
  <div class="modal fade" id={hit.id.replace("_", "-")} tabindex="-1" aria-labelledby={hit.id.replace("_", "-") + "Label"} aria-hidden="true">
          <div class="modal-dialog" id={hit.id.replace("_", "-")} >
          <div class="modal-content">
          <div class="modal-header justify-content-center">
          ...
          <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 justify-content-center row">
            <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace("_", "-") + "-img"} class="d-block blur-shadow-image">
