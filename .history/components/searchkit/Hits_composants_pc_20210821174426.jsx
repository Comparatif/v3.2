...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <ul class="dropdown-menu" aria-labelledby={hit.id}>
          ...
          <a class="dropdown-item bg-gradient-info text-white text-bold" href="#">
          Info
          </a>
      
          <a class="dropdown-item bg-gradient-success text-white text-bold" href="#">
          Success
          </a>
      
          <a class="dropdown-item bg-gradient-warning text-white text-bold"  href="#">
          Warning
          </a>
