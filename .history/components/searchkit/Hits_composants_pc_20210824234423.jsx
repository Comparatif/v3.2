...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {hit.fields.paiement.toString().includes("CCP") ? <img class="shadow col-lg-6 col-md-6 col-sm-6 col-6" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
    {hit.fields.paiement.toString().includes("Baridimob") ? <img class="shadow col-lg-6 col-md-6 col-sm-6 col-6" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    
      
    </div>
    <div class="col-lg-1 col-md-1 col-sm-1 col-1 mb-1 ps-1 p-1 px-md-2 px-lg-2" >
    
    { hit.fields.livraison != undefined ? hit.fields.livraison.toString().includes(" ") ? <img  class="col-lg-12 col-md-12 col-sm-12 col-12" style={{objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/shipped-icon-13.jpg"/> : "" : ""}
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 text-end ps-lg-1 pe-lg-3 ps-md-1 pe-md-3 ps-sm-1 pe-sm-3 px-1" >
          ...
          target="_blank"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 px-lg-3 py-lg-3" id="btn-fontsize" data-animation="true">Voir l'offre</button></a>
