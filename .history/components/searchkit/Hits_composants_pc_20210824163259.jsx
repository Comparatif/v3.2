...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {hit.fields.paiement.toString().includes("Baridimob") ? <img class="w-25" src="/img/custom/ccp.png"/>"/img/custom/baridimob.png" : "1"}
    {hit.fields.paiement.toString().includes("CCP") ? <img class="w-25" src="/img/custom/ccp.png"/> : "2"}
