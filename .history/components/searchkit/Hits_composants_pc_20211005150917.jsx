...
console.log(lesDescriptions)
  const description1 = lesDescriptions[0]?.description1
  const brand_name = lesDescriptions[0]?.brand_name
  const description2 = lesDescriptions[0]?.description2
  const prod_description = lesDescriptions[0]?.prod_description
  const prod_specs_big_title = lesDescriptions[0]?.prod_specs_big_title
  const total = lesDescriptions[0]?.total
  const names_bdd = lesDescriptions[0]?.product_names
