...
{data?.results.hits.items.map((hit) => (
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + hit.id.replace(/[0-9]/, 'Z') + "-img"}>
    ...
    {typeof hit.fields.paiement.toString().includes("CCP") ? <img class="shadow " style={{width: "50%", objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/ccp.png"/> : ""}
    {typeof hit.fields.paiement.toString().includes("Baridimob") ? <img class="shadow " style={{width: "50%", objectFit: "scale-down", aspectRatio: "1 / 1"}} alt="Baridimob" src="/img/custom/baridimob.png"/> : ""}
    
      
    </div>
    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 pe-1" >
    
    {typeof hit.fields.livraison.toString().includes(" ") ? <img class="shadow " style={{width: "50%", objectFit: "scale-down", aspectRatio: "1 / 1"}} alt= "CCP" src="/img/custom/shipped-icon-13.jpg"/> : ""}
