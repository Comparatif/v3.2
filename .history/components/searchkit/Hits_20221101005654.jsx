...
<div className="col-md-5 mb-0 p-0" >
...
<div className="col-md-7 mb-1 p-0" id="results1">
...
{data?.results.hits.items.map((hit) => (
  ...
  <div className="col-md-12 col-sm-12 col-12">
    ...
    {({i})=> {if (i===0) {prix}}}
      <h1 className="text-gradient text-info ms-1 mb-0" id="price-fontsize">{hit.fields.product_prices.replace(/\B(?=(\d{3})+(?!\d))/g, " ")} DA</h1>
