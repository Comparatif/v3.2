    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                if (screen.width < 767.98){
                  ...
                  <div class="col-6 justify-content-end text-start">
                  <button class="btn bg-gradient-info ">Description</button>
                  </div>
                  <div class="col-6">
                  <button class="btn bg-gradient-info justify-content-end text-end">Spécifications</button>
                  </div>
