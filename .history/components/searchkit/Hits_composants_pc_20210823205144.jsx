  ...
  <div class="nav-wrapper position-relative end-0">
   ...
   <div class="container p-0"><div class="row justify-content-center">
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 pe-1" >
         <a  class="nav-link btn bg-gradient-info mb-0 px-0 py-1" class= {viewType === "Liste" ? "nav-link btn bg-gradient-info mb-0 px-0 py-1" : {backgroundColor: "white", cursor: "pointer"}} onClick={Liste} data-bs-toggle="tab"  role="tab" aria-controls="profile" >
         Liste
         </a>
      </li>
      ...
      <li class="nav-item col-md-6 col-sm-6 col-6 ps-1" >
         <a  class="nav-link mb-0 px-0 py-1" style= {viewType === "Grille" ? transformer : {backgroundColor: "white", cursor: "pointer"}} onClick={Grille} data-bs-toggle="tab"  role="tab" aria-controls="dashboard" >
         Grille
         </a>
      </li>
