...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="modal fade" id={hit.id} tabindex="-1" aria-labelledby={hit.id + "Label"} aria-hidden="true">
          ...
          <img class="img-fluid border-radius-lg w-25" id="img-width" src={hit.fields.vendeurs_image} alt={hit.fields.vendeurs}/>
          
          
          </div>
          <div class="modal-body text-left">
          <strong>Pays </strong>: {hit.fields.product_country} <br/>
          <strong>Villes </strong>: {hit.fields.villes1} <br/>
          <strong></strong>Commune : {hit.fields.commune} <br/>
          <strong></strong>Adresse : {hit.fields.adresses} <br/>
          <strong></strong>Contact : {hit.fields.email} <br/>
          <strong></strong>Modes de paiement : {hit.fields.paiement} <br/>
          <strong></strong>Livraison : {hit.fields.livraison} <br/>
          <strong></strong>Heures d'ouvertures : {hit.fields.horaires} <br/>

          <strong></strong>Réseau sociaux : {hit.fields.facebook} {hit.fields.instagram} 
