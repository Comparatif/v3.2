...
export const HitsList = ({ data }) => {
  ...
  const transformer = ChangeView() === 'Liste' ? {padding: "0px", transition: "all 0.5s ease 0s", transform: "translate3d(0px, 0px, 0px)", width: "49%"} : {padding: "0px", transition: "all 0.5s ease 0s", transform: "translate3d(0px, 0px, 0px)", width: "49%"}
...
<div class='col-md-4 col-sm-4 col-4 mt-0 text-center'>
  ...
  <div class="nav-wrapper position-relative end-0">
   <ul class="nav nav-pills nav-fill p-1" role="tablist">
      ...
      <li class="nav-item" >
         <a  class="nav-link mb-0 px-0 py-1" style= {viewType === "Liste" ? {backgroundColor: "blue", cursor: "pointer"} : {backgroundColor: "white", cursor: "pointer"}} onClick={Liste} data-bs-toggle="tab"  role="tab" aria-controls="profile" aria-selected="true">
         Liste
         </a>
      </li>
      ...
      <li class="nav-item" >
         <a  class="nav-link mb-0 px-0 py-1" style= {viewType === "Grille" ? {backgroundColor: "blue", cursor: "pointer"} : {backgroundColor: "white", cursor: "pointer"}} onClick={Grille} data-bs-toggle="tab"  role="tab" aria-controls="dashboard" aria-selected="false">
         Grille
         </a>
      </li>
