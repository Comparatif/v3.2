...
import { Listea } from './Liste'
import { Grillea } from './Grille'
...
{viewType === "Liste" ? <Listea data={data} boutique_infos={boutique_infos} 
votesLoading={votesLoading} user={user} datetime={datetime} CanvasState={CanvasState}  SetCanvas={SetCanvas} /> 


: <Grillea data={data} boutique_infos={boutique_infos} votesLoading={votesLoading} 
