...
export const Maj = () => (
  ...
  <div class="row justify-content-center text-center">
    ...
    <h6 class="small">Dernière mise a jour : 27/08/2021</h6>
...
export const Footer = () => (
  ...
  <div class="text-center p-3" className= {styles.background}>
    ...
    <a class="text-white" href="https://comparatifdz.com/"><strong>Comparatifdz</strong></a>
  </div>
...
return (
  ...
  <button id="btn-fontsize" type="button" class="btn bg-gradient-info mb-0" data-bs-toggle="modal" data-bs-target="#exampleModal">Infos</button>
...
<p class= "small">Le but de ce site est de vous aider a trouver le prix <strong class="text-secondary">le moins cher et gagner du temps !</strong></p>
        ...
        <p class= "small"> Enfin, cette initiative a pour but d'aider a la fois les consommateurs et les vendeurs. 
            ...
            5- Si le prix d'un marchand ne correspond pas a celui affiché sur notre site veuillez nous le signaler ici : <a href={"mailto:" + comparatif.algerie@gmail.com + "?subject = Feedback = Message"}></a><strong>comparatif.algerie@gmail.com</strong><br/>
