...
useEffect(()=> 
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <div class="col-xl-11 row justify-content-center text-center  px-xl-1" >
    <div class="col-3 p-0 text-center"><small>{StarRating}</small></div>
    <div class="col-8 p-0"><AverageStars votesLoading={votesLoading}
    StarRating={StarRating} ListeNotesBoutique={ListeNotesBoutique}  
    cle={cle} CanvasState={CanvasState} size={15} className={styles.center} />
    </div>
    </div>
