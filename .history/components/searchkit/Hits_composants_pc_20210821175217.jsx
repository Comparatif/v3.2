...
{data?.results.hits.items.map((hit) => (
  ...
  <div class="col-md-12 col-sm-12 col-12">
    ...
    <ul class="row dropdown-menu justify-content-between" aria-labelledby={hit.id}>
    

      <div >
          <a class="dropdown-item" href="#">
          <button type="button" class="btn bg-gradient-info">Détails</button>
          </a>
      
          <a class="dropdown-item " href="#">
          <button type="button" class="btn bg-gradient-success">Appeler</button>
          </a>
          </div>
          ...
          <a class="dropdown-item " href="#">
          <button type="button" class="btn bg-gradient-warning">Localisation</button>
          </a>
