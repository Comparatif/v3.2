...
<div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 mt-1 px-1 text-small text-center" ><h6 class="m-0" id="price-fontsize">Prix & Stock</h6></div>
<div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 mt-1 px-0 px-sm-1 px-md-2 px-lg-2 text-start " ><h6 class="m-0" id="price-fontsize">Paiement</h6></div>
<div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 mt-1 px-0 px-sm-2 px-md-2 px-lg-1 text-start" ><h6 class="m-0" id="price-fontsize">Livraison</h6></div>
<div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-1 mt-1 px-0 px-sm-0 px-md-0 px-lg-0 text-start"  ><h6 class="m-0" id="price-fontsize">Marchand</h6></div>
