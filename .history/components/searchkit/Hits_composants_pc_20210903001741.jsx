...
{data?.results.hits.items.map((hit) => {
  ...
  const images_produits = hit.fields.product_imagelinks
  ...
  <a style={{cursor : "pointer"}} class="hover_img" >
    <h6 class="mt-1 mx-1 mb-0" id="title-style">{hit.fields.product_names}</h6>
    <img src={images_produits} alt={hit.fields.product_names} height="100" />
    </a>
    </div>
