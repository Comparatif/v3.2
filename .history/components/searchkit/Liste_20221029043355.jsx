...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
  ...
  <a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
    ...
    <ul class="dropdown-menu z-index-1"  aria-labelledby={cle}>
          ...
          <a class="dropdown-item text-bold" href={localisation} target="_blank" rel="noreferrer">
          <li>
          <img src="/img/custom/map.svg"/> Localisation
          </li>
          </a>

          <a class="dropdown-item text-bold" href={shop_website} target="_blank" rel="noreferrer">
          <li>
...
<div  class="col-lg-12 col-md-12 col-sm-12 col-12 mb-1 text-end ps-lg-1 pe-lg-1 ps-md-1 pe-md-1 ps-sm-1 pe-sm-1 ps-1" >
          ...
          target="_blank" rel="noreferrer"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize-product" data-animation="true">Voir l'offre</button></a>
...
<div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-1 text-end ps-lg-1 pe-lg-3 ps-md-1 pe-md-3 ps-sm-1 pe-sm-3 ps-1" >
          ...
          <a href={product_links} 
          target="_blank" rel="noreferrer"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize" data-animation="true">Voir l'offre</button></a>
