...
useEffect(() => {
  ...
  var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
    ...
    var tooltip = new bootstrap.Tooltip(tooltipTriggerEl, {trigger: "manual"})
    ['mouseover','mouseleave'].forEach( evt => 
      tooltipTriggerEl.addEventListener(evt, dosomething, false)
      return tooltip.enable() && tooltip.show()
  );
