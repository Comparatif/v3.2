    ...
    <div class="row align-items-center">
      ...
      <div class="card card-blog card-plain">
                ...
                <a class="text-center" href={isBrowser ? window.location.href : ''}>
                    ...
                    <p>
                    <small >
                  {!names_bdd ? "" : description1}  <Image src="/img/custom/info.svg" alt="" title="" data-bs-original-title="Beta : la description peut ne pas correspondre a la recherche dans certains cas."   data-bs-toggle="tooltip" data-bs-placement="right"/></small></p>
                  </a>
                  <a class="row justify-content-center blur-shadow-image">
                    <Image src={product_imagelinks} alt={product_names} class="img-fluid shadow border-radius-lg w-50" style={{objectFit: "cover", aspectRatio: "1 / 1"}}/>
                  </a>
