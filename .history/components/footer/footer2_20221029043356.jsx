...
<a class="dropdown-item border-radius-md"><span class="ps-1">Politique de confidentialité</span></a>
        ...
        <div class="col-lg-5 ms-auto text-lg-right text-center">
          ...
          <a href="https://www.facebook.com/Comparatifdz" target="_blank" rel="noreferrer" class="text-white me-xl-4 me-4 opacity-5">
            <span class="fab fa-facebook" aria-hidden="true"></span>
          </a>
          <a href="javascript:;" target="_blank" rel="noreferrer" class="text-white me-xl-4 me-4 opacity-5">
