...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : "Pas encore de note !"
    ...
    return (
      <>
      <div class="col-xl-8 row justify-content-center text-center px-lg-1"
      data-bs-original-title={StarRating === 0 ? "Ce marchand n'a pas encore de note, notez le !"}  data-bs-toggle="tooltip" data-bs-placement="top"
