    ...
    <div class="card card-plain card-blog mx-2">
      <div class="card-image border-radius-lg position-relative">
        <a href={hit.fields.product_links}>
          <img class="w-100 border-radius-lg move-on-hover shadow produits_favoris_image" onerror="this.style.display='none'" src={hit.fields.product_imagelinks} />
        </a>
      </div>
...
{data?.results.hits.items.slice(0,20).map((hit)=>(
    ...
    <div class="card card-plain card-blog mx-2">
      <div class="card-image border-radius-lg position-relative">
        <a href={hit.fields.product_links}>
          <img class="w-100 border-radius-lg move-on-hover produits_favoris_image" onerror="this.style.display='none'" src={hit.fields.product_imagelinks} />
        </a>
      </div>
      <div class="card-body px-0 pt-3 pb-0">
