...
export const UserConnected = ({cle, boutique_infos, datetime, boutique
  , commentaire, StarRating, ListeNotesBoutique, user, CanvasState, SetCanvas, Vendeur_image}) => {
...
<img class="col-8" id="img-width" src={Vendeur_image} alt="Unitech-dz" class="img-fluid border-radius-lg"/>
