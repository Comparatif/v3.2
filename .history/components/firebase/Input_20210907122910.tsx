              ...
              <div className="card-body pb-2">
                ...
                <div className="row">
                  <div className="col-md-12 text-center">
                    <button type="submit" className={getValues("commentaire") == undefined ? "" : "btn bg-gradient-primary mt-3 mb-0"} {getValues("commentaire") == undefined ? disabled : undefined}>Send Message</button>
                  </div>
                </div>
              </div>
            </form>
