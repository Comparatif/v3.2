            ...
            <form onSubmit={handleSubmit(onSubmit)} id="contact-form" >
              <div class="card-body pb-2">
                ...
                <div class="form-group mb-0 mt-md-0 mt-4">
                  ...
                  <textarea {...register("commentaire")} placeholder="Laisser un commentaire"  class="form-control" id="message" rows="6" placeholder="Describe your problem in at least 250 characters"></textarea>
                </div>
                <div class="row">
