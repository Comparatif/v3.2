...
export const UserConnected = ({cle, boutique_infos, datetime, boutique
  ...
  return (
    <>
    <div class="modal fade" id={"Rating" + cle} tabindex="-1" role="dialog" aria-labelledby={"Rating" + cle} aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn ml-auto btn-close" data-bs-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
    ...
    {useEffect(() =>
      {
        var myModals = document.getElementById("Rating" + cle)
        
      return (new bootstrap.Modal(myModals).show() )
