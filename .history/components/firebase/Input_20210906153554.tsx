            ...
            <form onSubmit={handleSubmit(onSubmit)} id="contact-form" >
              <div class="card-body pb-2">
                ...
                <div class="form-group mb-0 mt-md-0 mt-4">
                  ...
                  <textarea {...register("commentaire")} placeholder="Laisser un commentaire"  class="form-control" id="message" rows="6" placeholder="Donnez votre avis sur ce marchand"></textarea>
                </div>
                <div class="row">
