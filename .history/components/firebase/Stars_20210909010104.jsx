...
export const AverageStars = ({StarRating, ListeNotesBoutique, cle, votesLoading, CanvasState}) => {
  ...
  */
  ...
  data-bs-trigger="hover"
      ...
      {useEffect(() =>
        {
        var myTooltipEl = document.getElementById('SignUp-form-' + cle)
        ...
        tooltip.hide()
          ...
          var tooltipsOff = document.getElementById("tooltip-" + cle);
          
         ( CanvasState == "SignUp-form-" + cle) ? (new bootstrap.Offcanvas(tooltipsOff).hide() )  : ""
      })}
</div>
