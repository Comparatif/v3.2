...
<AverageStars votesLoading={votesLoading}
    ...
    {ListeNotesBoutique?.length} avis
      ...
      <div class="h-75">
      <button type="button" class="btn bg-gradient-info" onClick={() => setAvis('Commenter')} >Commenter</button>
      <button type="button" class="btn bg-gradient-info" onClick={() => setAvis('Avis')} >ListeAvis</button>
      {Avis !== 'Commenter' ? 
