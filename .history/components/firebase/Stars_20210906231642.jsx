...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
    ...
    data-bs-trigger= "manual"
      ...
      {isOn ? 
        ...
        datetime={datetime} StarRating={StarRating} ListeNotesBoutique={ListeNotesBoutique} />
      :  <Auth cle={cle} />}
      ...
      {useEffect(() =>
        {var ModalClose = document.getElementsByClassName("modal-backdrop fade show")
          var myModal = document.getElementById("SignUp-form-" + cle)
          myModal?.addEventListener('hide.bs.modal', function () {
            return toggleIsOn(false) && myModal.hide() && ModalClose.hide()
          })
          
          ModalClose?.addEventListener('hide.bs.modal', function () {
            return ModalClose.hide()
          })
