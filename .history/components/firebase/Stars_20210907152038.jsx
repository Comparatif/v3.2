...
export const AverageStars = ({boutique_infos, boutique, user, loading, datetime, cle}) => {
  ...
  //console.log(canevas)
  //const ShouldCanevasDisapear = canevas?.map((a) => a.id).includes("SignUp-form-" + cle)
  //console.log(canevas > 1 ? ShouldCanevasDisapear : "")
  console.log(canevas?.map((a) => a.id).toString())
          })
