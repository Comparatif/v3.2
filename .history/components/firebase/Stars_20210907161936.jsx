...
toggleIsOn(false) && document.getElementById("SignUp-form-" + cle)?.hide() 
     ...
     {useEffect(() =>
      ...
      var canevas = [].slice(document.querySelectorAll('[class="offcanvas offcanvas-end show"]'));

        (canevas?.map((a) => a.id)).at(-1) == "SignUp-form-" + cle ? "" : toggleIsOn(false) && document.getElementById("SignUp-form-" + cle)?.hide()
