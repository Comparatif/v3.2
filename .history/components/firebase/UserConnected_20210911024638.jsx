...
<div class="row justify-content-center">
<div class="col-2 px-0 pt-2"><h2>{StarRating}</h2></div>
...
<AverageStars votesLoading={votesLoading}
    ...
    cle={cle} CanvasState={CanvasState} size={30}/></div>
    ...
    <div class="row justify-content-center col-6">
        <StarsRate className={"w-50"} ratingChanged={ratingChanged} boutique={boutique} size={34}/>
        </div>
