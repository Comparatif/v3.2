...
export const UserConnected = ({cle, boutique_infos, datetime, boutique
  ...
  return (
    ...
    <div class="offcanvas offcanvas-end" data-bs-backdrop="false" id={"SignUp-form-" + cle} tabindex="-1" role="dialog" aria-labelledby={"SignUp-form-" + cle} aria-hidden="true">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-link  ml-auto" data-bs-dismiss="offcanvas">Close</button>
      </div>
  ...
  {useEffect(() =>
    ...
    var canevas = [].slice.call(document.querySelectorAll('[class="offcanvas offcanvas-end show"]'));
     ...
     canevas?.length > 1 ? ((canevas?.map((a) => a.id).at(-1) == "SignUp-form-" + cle) ? "" : once(toggleIsOn(false)) && document.getElementById("SignUp-form-" + cle)?.hide()) : ""
     console.log(canevas?.length)
    }
