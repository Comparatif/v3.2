...
export const AverageStars = ({StarRating, ListeNotesBoutique, cle, votesLoading, CanvasState={CanvasState}}) => {
  ...
  */
  ...
  data-bs-trigger="hover"
      ...
      {useEffect(() =>
        {
          var tooltipsOff = document.getElementById("SignUp-form-" + cle)
          
           return (new bootstrap.Offcanvas(tooltipsOff).show() ) 
      })}
</div>
