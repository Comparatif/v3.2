...
export const VoterList = ({ id, vote, shop, datetime, boutique, commentaire }) => {
  ...
  return (
    ...
    <div class="row justify-content-start text-start my-1" style={{borderBottom: '1px solid rgba(191, 191, 191, 0.25)'}}
    ...
    <img
      ...
      <div class="col-6 text-small"> <p><small>{heure}</small></p></div>
        </div>
