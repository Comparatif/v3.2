...
export const UserConnected = ({cle, boutique_infos, datetime, boutique
  ...
  return (
    <>
    <div class="modal fade" id={"SignUp-form-" + cle} tabindex="-1" role="dialog" aria-labelledby={"Rating" + cle} aria-hidden="true">
    ...
    {useEffect(() =>
      {
        var myModal = document.getElementById("Rating" + cle)
