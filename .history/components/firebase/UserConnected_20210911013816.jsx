...
<AverageStars votesLoading={votesLoading}
    ...
    {ListeNotesBoutique?.length} avis
      ...
      <div class="h-75">
      <button type="button" class="btn bg-gradient-info" onClick={()=> Commenter()} >Commenter</button>
      <button type="button" class="btn bg-gradient-info" onClick={()=> ListeAvis()} >Commenter</button>
      {Avis == 'Commenter' ? 
