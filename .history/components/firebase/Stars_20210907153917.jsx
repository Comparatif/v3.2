...
toggleIsOn(false) && document.getElementById("SignUp-form-" + cle)?.hide() 
          ...
          var ShouldCanevasDisapear = canevas?.length > 1 ? canevas?.map((a) => a.id).slice(-1).toString().includes("SignUp-form-" + cle) : undefined
          ShouldCanevasDisapear ? (toggleIsOn(false) && document.getElementById("SignUp-form-" + cle)?.hide()) : undefined
          console.log(ShouldCanevasDisapear)
