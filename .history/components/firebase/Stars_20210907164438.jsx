...
toggleIsOn(false) && document.getElementById("SignUp-form-" + cle)?.hide() 
     ...
     {useEffect(() =>
      ...
      const canevas = [].slice.call(document.querySelectorAll('[class="offcanvas offcanvas-end show"]'));
      
       canevas?.length > 1 ? ((canevas?.map((a) => a.id)).at(-1) == "SignUp-form-" + cle ? "" : toggleIsOn(false) && document.getElementById("SignUp-form-" + cle)?.hide()) : ""
