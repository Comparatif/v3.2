...
const StarRating = Resultat > 0 ? Number(Resultat.toFixed(1)) : 0
    ...
    | Avis: ${ListeNotesBoutique?.length}` }
      ...
      >
      <div data-bs-toggle="modal" data-bs-target={"#SignUp-form-" + user.toString()}>
        <ReactStars
      ...
      {!user && <Auth />}
      <div class="modal fade" id={"SignUp-form-" + user.toString()} tabindex="-1" role="dialog" aria-labelledby={"#SignUp-form-" + user.toString()} aria-hidden="true">
