      ...
      {useEffect(() =>
        {
          ...
          const divs = document.querySelectorAll('[class="tooltip fade show bs-tooltip-bottom"]');

          divs.forEach(el => el.addEventListener('show.bs.offcanvas', event => {
            return event.remove();
          }));

        //var myTooltipEl = document.getElementsByClassName('[class="tooltip fade show bs-tooltip-bottom"]')
        
        
        myTooltipEl.addEventListener('show.bs.offcanvas', function () {
          return myTooltipEl.remove()
        })
