...
const Page = () => {
  ...
  const total = lesDescriptions['0']?.f
      ...
      <meta name="description" content={names + " Algérie | Prix le moins cher : " + price + " DA | "+ categories +   " | Marque : " + marques + " | Boutique : " +boutique}/>
      ...
      <meta property="og:description" content={names + " Algérie | Prix le moins cher : " + price + " DA | "+ categories +   " | Marque : " + marques + " | Boutique : " +boutique}/>
      <meta name="twitter:card" content="summary"/>
      <meta name="keywords" content= {names +"prix Algérie - Comparatif, gaming, config, ryzen, intel, HP, ASUS, MSI, NVIDIA, AMD, RTX, GTX"}/>
