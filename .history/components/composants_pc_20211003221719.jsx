...
const description_part1  = `
  query resultSet($query: String, $filters: [SKFiltersSet], $page: SKPageInput, $sortBy: String) {
    description(query: $query, filters: $filters, queryOptions: { fields: [`
...
const descriptionquery1 = gql`${part1 + `"and"` + part2}`
const query2 = gql`${part1 + `"or"` + part2}`
...
const Page = () => {
  ...
  const { description_previousData, description_data = previousData, description_loading } 
