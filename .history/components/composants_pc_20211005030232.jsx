...
const Page = () => {
  ...
  const { previousData, data = previousData, loading } = useQuery(query, { variables })
    ...
    return (
      ...
      <meta name="keywords" content= {names + " | "+ categories + "Meilleur prix Algérie, - Prix, stocks & avis- Comparatif, gaming, config, ryzen, intel, HP, ASUS, MSI, NVIDIA, AMD, RTX, GTX"}/>
