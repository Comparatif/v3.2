...
useEffect(()=>{
  ...
  api.search()
    ...
    return (
      ...
      <meta name="description" content="Comparer les prix pour vos achats en ligne avec Comparatifdz.com, comparateur de prix pour acheter moins cher ! ✓ Avis ✓ Tests produits ✓ Comparatifs. Comparateur de prix Algérie. Matériel informatique : cartes graphiques, processeurs, cartes mères... Laptop & PC fixes "/>
      ...
      <meta property="article:modified_time" content="10/10/2021"/>
      <meta property="og:image" content= {data?.results.hits.items.slice(0,1).map((hit)=>hit.fields.product_imagelinks)}/>
      <meta property="og:image:width" content="600"/>
      <meta property="og:image:height" content="600"/>
      <meta property="og:description" content="Comparateur de prix Algérie. Matériel informatique : cartes graphiques, processeurs, cartes mères... Laptop & PC fixes "/>
