...
const Page = () => {
  ...
  const { previousData, data = previousData, loading } = useQuery(query, { variables })
    ...
    return (
      ...
      <meta name="description" content={names + " Algérie | Prix le moins cher : " + price + " DA | "+ categories +   " | Marque : " + marques + " | " +description1}/>
      ...
      <meta property="og:description" content={names + " Algérie | Prix le moins cher : " + price + " DA | "+ categories +   " | Marque : " + marques + " | " +description1}/>
      <meta name="twitter:card" content="summary"/>
      <meta name="keywords" content= {names + + categories + "prix Algérie - Comparatif, gaming, config, ryzen, intel, HP, ASUS, MSI, NVIDIA, AMD, RTX, GTX"}/>
