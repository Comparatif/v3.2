  ...
  useEffect(()=> {
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              <> <LeftField querys={querys}setData= {setData} isSelected = {isSelected} setSelect = {setSelect} sss={sss} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
