...
return(
  ...
  <div className="table-responsive table_height">
    <button class="btn btn-sm  bg-gradient-primary  btn-round mb-0 mx-4 mt-2 mt-md-0" onClick={() => {handleDownloadExcel(excelData)}}> Export Excel </button>
    <button class="btn btn-sm  bg-gradient-primary  btn-round mb-0 mx-4 mt-2 mt-md-0" onClick={() => {handleDownloadExcel(excelData)}}> Export PDF </button>
