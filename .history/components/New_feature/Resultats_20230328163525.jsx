...
data?.results.hits.items.map((hit) => {
    ...
    return(
        ...
        <td key={cle} className="results_ligne w-100 border-radius-lg move-on-hover shadow">
  ...
  <ul className="dropdown-menu z-index-3" aria-labelledby={cle}>
    ...
    <img src="/img/custom/info.svg"/> Détails
      ...
      <h3 className="text-gradient text-info mb-1 col-8 p-0 z-index-1" id="price-fontsize-ligne" ><small>{product_prices.replace(/\B(?=(\d{3})+(?!\d))/g, " ")} DA</small></h3>
