...
/* La Barre de recherche */
    ...
    const PriceSearch = <>{()=> {api.setSortBy('prix_croissant'); api.search()}}  <>{LeftField}  {resultats}</></>
    const RelevanceSearch = <>{()=> api.setSortBy('relevance'); api.search()}  <Resultats data={data}/></>
