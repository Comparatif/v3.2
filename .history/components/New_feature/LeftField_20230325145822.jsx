...
export const LeftField = ({updatetest123, data, isOn, toggleIsOn, setQuery, liste, IndexChange, id, SearchState}) => 
...
{ShowSearchBar ?
<AutoCompleteText_ligne updatetest123={updatetest123} id={id} api={api} SearchState={SearchState} toggleIsOn={toggleIsOn} setQuery={setQuery} items={liste} index={IndexChange}/>
