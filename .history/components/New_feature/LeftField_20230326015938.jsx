...
<a className="justify-content-center" style={{cursor : "pointer"}} onClick={()=> toggleIsOn()} >
  ...
  <p className="text-xs text-secondary mt-1">Tri: {CheckIfSorted == "prix_croissant" ? "Par Prix" : "Pertinence"}</p>
