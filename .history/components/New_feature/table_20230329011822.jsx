...
<div class="col-md-4">
<div class="p-1 text-center">
<h6 class="mt-1" >Export Excel : </h6><button class="btn btn-sm  bg-gradient-success btn-round mb-0 mx-0 mt-2 mt-md-0 px" onClick={() => {handleDownloadExcel(excelData)}}>Télécharger</button>
</div>
</div>
</div>
</div>
