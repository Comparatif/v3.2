...
data?.results.hits.items.map((hit, col) => {
  ...
  <img id="img-width" src={vendeurs_image} alt={vendeurs} className="img-fluid border-radius-2xl img_white " style={{maxheight: "20px", objectFit: "scale-down", aspectRatio: "20/9"}}/>
  </a>
