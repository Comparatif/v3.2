...
return(
  ...
  <div className="table-responsive table_height">
    ...
    <table className="table align-items-center mb-0" >
      ...
      <tbody>
        <div>1 {setExcelData(excelData.splice(id-1, 0, list1))}</div>
        <div>2 {setExcelData(excelData.splice(id-1, 0, list1))}</div>
        <div>3 {setExcelData(excelData.splice(id-1, 0, list1))}</div>
      {elements}
