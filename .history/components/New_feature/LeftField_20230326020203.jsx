...
<a className="pt-0" style={{cursor : "pointer"}} onClick={()=> toggleIsOn()} >
  ...
  <p className="text-xs text-secondary mb-0">Tri: {CheckIfSorted == "prix_croissant" ? "Par Prix" : "Pertinence"}</p>
