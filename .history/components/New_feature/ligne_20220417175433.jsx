...
`
  ...
  //const { previousData2, data2 = previousData2, loading2 } = useQuery(query2, { variables })
    ...
    useEffect(()=>{
      ...
      api.search()
      {() => SetResultsCount(CheckIfZeroResults)}
    }, [router.isReady]);

    console.log("CheckIfZeroResults = " + CheckIfZeroResults)
    console.log("Resultcount = " + ResultsCount)
  ...
  <img src="/img/custom/info.svg"/> Détails
    ...
    return(
            ...
            {loading ? LoadingLogo :
              ...
              <div CheckIfZeroResults={CheckIfZeroResults}>
