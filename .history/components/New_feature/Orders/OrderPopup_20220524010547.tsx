...
var date = (currentdate.getDate()) + (currentdate.getMonth()+1)  +  (currentdate.getFullYear())
    ...
    const shop_commune = hit?.fields.user_commune
...
try{
  ...
  e.preventDefault()
    ...
    const DatabaseSeed= Object.assign(Object.assign(data, hit?.fields), {orderId : id, shopEmail: shopEmail, vendeurName: vendeurs})
