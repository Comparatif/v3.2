...
try{
  ...
  e.preventDefault()
    ...
    const DatabaseSeed= Object.keys(Object.assign(data, hit?.fields)).forEach(({ email, ...e }) => ({ ...e, shopEmail: email }))
    const DatabaseSeed1= Object.defineProperty(DatabaseSeed, 'shopEmail', {
      value: shopEmail,
    });
    {id : id, shopEmail: shopEmail}
