...
:
 ...
 Effectuer une commande
  ...
  Nous vous contacterons dans les plus brefs délais afin de vous mettre en relation avec le marchand. <img src="/img/custom/info.svg" title="" data-bs-original-title="Nous ne vendons en aucun cas le produit seléctionné. Nous nous chargeons uniquement de vous mettre en relation avec le marchand"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right"/>
  </p>
  </div>
  <div className="card-body">
