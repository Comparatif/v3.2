...
const isSold = Orders?.docs?.filter((doc)=> doc.data().sold === true).length
const isSold = Orders?.docs?.filter((doc)=> doc.data().sold === false).length

return ({CA: CA, OrdersNumber: OrdersNumber, })
}
