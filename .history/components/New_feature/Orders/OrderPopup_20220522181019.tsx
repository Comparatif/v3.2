...
<select onChange={(e:any)=> setData({
    ...
    className={isCommuneCompliant ? "form-control is-valid" : isOrderTrigger && !isCommuneCompliant ? "form-control is-invalid" : "form-control"} name="choices-button-user_commune" id="choices-button-commune" placeholder="Commune" >
