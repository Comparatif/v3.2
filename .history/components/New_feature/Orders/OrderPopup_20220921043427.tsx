...
:
 ...
 Effectuer une commande
  ...
  Nous vous contacterons dans les plus brefs délais afin de vous mettre en relation avec le marchand. <img src="/img/custom/info.svg" class={IsComposantsSelected ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right"/>
  </p>
  </div>
  <div className="card-body">
