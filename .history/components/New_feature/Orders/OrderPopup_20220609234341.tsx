...
var date = (currentdate.getDate()) + (currentdate.getMonth()+1)  +  (currentdate.getFullYear())
  ...
  const doesOrderExist = async () => {
    ...
    .then((data) => {
      ...
      :
      SetOrderContext({...OrderContext, isOrderTaken: false, isOrderModified: false, hit: hit, boutique:vendeurs, product_name: product_names}) && tryPrisma
...
!OrderContext?.isOrderTaken || !OrderContext?.isOrderAlreadyTaken ? 
 ...
 Effectuer une commande
  ...
  <form role="form text-left" onSubmit={user ? tryPrisma: (doesOrderExist ? null: tryPrisma)} method="post">
  <div className="row">
  <div className="col-4">
  <label>Prénom</label>
