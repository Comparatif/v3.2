...
const Prix = Orders?.docs?.map( (doc) => doc.data().Infos_boutique.product_prices)
const CA = Prix.reduce((a, b) => a + b, 0)
console.log(Prix)
...
return OrdersLoading ? "Chargement..." : Prix.reduce((a, b) => a + b, 0)
}
