...
!OrderContext?.isOrderTaken || !OrderContext?.isOrderAlreadyTaken ? 
 ...
 Effectuer une commande
  ...
  <form role="form text-left" onSubmit={user ? tryPrisma: (doesOrderExist && OrderContext?.isOrderTaken? null: tryPrisma)} method="post">
  <div className="row">
  <div className="col-4">
  <label>Prénom</label>
...
<div className="card card-plain">
  ...
  {OrderContext?.isOrderAlreadyTaken ? "Commande deja prise en compte" : "Commande prise en compte"}
  </h3>
