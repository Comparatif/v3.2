...
try{
  ...
  const OrderConfirmation = isLastnameCompliant && isFirstnameCompliant && isPhoneCompliant && isCityCompliant && isCommuneCompliant
    ...
    const tryPrisma = async (e:any) => {
      ...
      const  DatabaseSeed = Object.assign(Object.assign(data, hit?.fields), {orderId : orderId, shopEmail: shopEmail, shop_commune: shop_commune, product_prices:product_prices})
