...
const Ligne = ({id, SearchState, updatetest123}) => {
  const query  = gql`
...
/* La Barre de recherche */
  ...
  const sss = SearchState.test123?.split("##!;#2")[id-1]
  ...
  useEffect(()=> {
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              CheckRelevance ? <> <LeftField sss={sss} updatetest123={updatetest123} id={id} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              ...
              <> <LeftField sss={sss} updatetest123={updatetest123} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <Resultats data={data}/>{api.setSortBy('relevance')} {api.search()}</> : 
              
              
              <><LeftField updatetest123={updatetest123} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
