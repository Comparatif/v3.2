...
data?.results.hits.items.map((hit, col) => {
    ...
    return(
        ...
        <td 
          ...
          key={cle} 
          className={isSelected.row === id && isSelected.col === col ? "nav-item results_ligne border-radius-xl shadow m-1 bg-gradient-info"  :"results_ligne border-radius-xl shadow m-1" }
  ...
  <ul className="dropdown-menu z-index-3" aria-labelledby={cle}>
    ...
    <img src="/img/custom/info.svg"/> Détails
      ...
      <i className={"fas fa-credit-card mx-1 outline_icons"} style={{color: paiement?.toString() === "" ? "" : "green" }}
