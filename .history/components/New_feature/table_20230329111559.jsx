  ...
  <div className="px-sm-0">
    <div className="row align-items-center">
      ...
      <div className="card card-blog card-plain">
                ...
                <div className="card-body px-1 pt-3 pb-0 justify-content-center">
                  ...
                  <button className="btn bg-gradient-info btn-lg col-5 py-2 px-1 mx-1" onClick={toggleIsOn2} >{isOn2 ? 'Description' : 'Spécifications'}</button>
                  <button onClick={() => {
                    if (typeof window !==  'undefined') {
                if (screen.width < 767.98){
                        document.getElementsByTagName("BUTTON")[2].scrollIntoView();
                        }}
                    }} type="button" className="btn bg-gradient-info btn-lg col-5 py-2 px-1 mx-1">Comparer {data?.data?.results?.summary.total} offres</button>
