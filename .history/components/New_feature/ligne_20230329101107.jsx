...
const Ligne = ({setData, id, SearchState, isOn4, excelData, setExcelData, isSelected, setSelect}) => {
  const query  = gql`
  ...
  useEffect(()=> {
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              CheckRelevance ? <> <LeftField isSelected = {isSelected} setSelect = {setSelect} sss={sss} id={id} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <p>Pas de Résultats</p></> : 

              <> <LeftField isSelected = {isSelected} setSelect = {setSelect} sss={sss} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <Resultats isSelected = {isSelected} setSelect = {setSelect} data={data} id={id}/>{api.setSortBy('relevance')} {api.search()}</> : 
              
              
              <><LeftField isSelected = {isSelected} setSelect = {setSelect} sss={sss} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <Resultats isSelected = {isSelected} setSelect = {setSelect} data={data} id={id}/>{api.setSortBy('prix_croissant')}</>}
