...
return(
 ...
 Suivi de la commande
  ...
  <SuiBox class="col-12 p-2" textAlign="left">
      ...
      value={e.sold ? 100 : e.canceled ? 100 : e.accepted ? 50 : e.pending ? 33 : 0} 
...
<p class={e.sold ? "col-4 text-end text-bold text-success" : e.canceled ? "col-4 text-end text-bold text-danger" : e.accepted ? "col-4 text-end text-bold text-info" : e.pending ? "col-4 text-end text-bold text-secondary" : ""}>{e.canceled ? "Annulée" : "Vendue"}</p>
</div>
      </SuiBox> 
