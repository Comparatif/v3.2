...
const { id, pending, accepted, acceptedBy, acceptedAt, sold, soldBy, soldAt, canceled, canceledBy, canceledAt, canceledWhy } = e ;
  ...
  const CancelOrder = async (cancelWhy) => {

    updateOrder({variables: {id: e.id, canceled: true, canceledBy: user?.email, canceledAt: datetime, cancelWhy: cancelWhy}})

  }

  const SellOrder = async () => {

    updateOrder({variables: {id: e.id, canceled: true, canceledBy: user?.email, canceledAt: datetime }})
...
<Cancel loading={loading} e={e} CancelOrder={CancelOrder} />
