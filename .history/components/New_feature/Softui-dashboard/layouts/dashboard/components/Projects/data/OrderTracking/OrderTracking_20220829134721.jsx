...

{
  ...
  const [CancelWhyHook, setCancelWhyHook] = useState({
    cancelWhy: '',
    textAera: '',
  })
  const CommentToReturn = CancelWhyHook.cancelWhy + CancelWhyHook.textAera
...
const { id, pending, accepted, acceptedBy, acceptedAt, sold, soldBy, soldAt, canceled, canceledBy, canceledAt, canceledWhy } = e ;
  ...
  const CancelOrder = async () => {
    ...
    updateOrder({variables: {id: e.id, canceled: true, canceledBy: user?.email, canceledAt: datetime, cancelWhy: CommentToReturn}})
...
<Cancel loading={loading} e={e} CancelOrder={CancelOrder} CancelWhyHook={CancelWhyHook} setCancelWhyHook={setCancelWhyHook} />
