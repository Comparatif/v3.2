...
export default function data({ loading, data, error, fetchMore }) {
...
if (loading) {
  return {columns: [], rows:[{loading:"Loading...."}]}
  
}
if (error) {
  return {columns: [], rows:[{loading:"Oops, something went wrong"}]}
}
