...
<p class={e.sold ? "col-4 text-center text-success" : e.canceled ? "col-4 text-center text-danger" : e.accepted ? "col-4 text-center text-bold text-info" : e.pending ? "col-4 text-center text-bold text-secondary" : ""}>Acceptée</p>
