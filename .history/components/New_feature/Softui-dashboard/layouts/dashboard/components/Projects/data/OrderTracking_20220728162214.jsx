...
<p class={e.sold ? "col-4 text-start text-bold text-success" : e.canceled ? "col-4 text-start text-bold text-danger" : e.accepted ? "col-4 text-start text-bold text-info" : e.pending ? "col-4 text-start text-warning" : ""}>Commandée</p>
<p class={e.sold ? "col-4 text-center text-success" : e.canceled ? "col-4 text-center text-danger" : e.accepted ? "col-4 text-center text-info" : e.pending ? "col-4 text-center text-secondary" : ""}>Acceptée</p>
<p class={e.sold ? "col-4 text-end text-success" : e.canceled ? "col-4 text-end text-danger" : e.accepted ? "col-4 text-end text-info" : e.pending ? "col-4 text-end text-warning" : ""}>{e.canceled ? "Annulée" : "Vendue"}</p>
</div>
      </SuiBox> 
