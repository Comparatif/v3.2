...
<div class="form-group">
    ...
    value={data.textAera}
    className={isPhoneCompliant ? "form-control is-valid" : isOrderTrigger && !isPhoneCompliant ? "form-control is-invalid" : "form-control"} placeholder="Téléphone" aria-label="Téléphone" aria-describedby="Téléphone"
