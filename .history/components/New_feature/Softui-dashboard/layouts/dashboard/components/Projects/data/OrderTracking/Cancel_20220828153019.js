...
export const Sell = ({loading, e, CancelOrder}) => (
    ...
    <div class="modal fade" id="sell" tabindex="-1" role="dialog" aria-labelledby="confirmationLabel" aria-hidden="true">
    ...
    Ok
      ...
      <p>En appuyant sur completer vous confirmez avoir délivrer l'article au destinataire</p>
        ...
        <button type="button" class="btn bg-gradient-info col-5 p-2 m-2" onClick={SellOrder}>Confirmer</button>
        </>
      }
        </div>
