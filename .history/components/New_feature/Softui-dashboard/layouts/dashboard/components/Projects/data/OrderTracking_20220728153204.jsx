...
return(
 ...
 { e ?
  <SuiBox width="8rem" textAlign="left">
      ...
      value={e.sold ? 100 : Data.canceled ? 100 : Data.accepted ? 66 : Data.pending ? 33 : 0} 
      color={e.sold ? "success" : Data.canceled ? "error" : Data.accepted ? "info" : Data.pending ? "warning" : "secondary"} 
