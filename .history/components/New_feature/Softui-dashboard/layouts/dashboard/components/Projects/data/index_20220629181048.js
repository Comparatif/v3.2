...
console.log(Data)
    ...
    Produits: [e.product_imagelinks, e.product_names + " (" + e.shop_commune + ")"],
    Nom: [e.product_imagelinks, e.product_names + " (" + e.shop_commune + ")"],
    Prenom: [e.product_imagelinks, e.product_names + " (" + e.shop_commune + ")"],
    Boutiques: (
