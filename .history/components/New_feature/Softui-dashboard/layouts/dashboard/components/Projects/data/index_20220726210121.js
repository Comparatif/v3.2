      ...
      <SuiBox width="8rem" textAlign="left">
        {
          ...
          <SuiProgress value={33} color="warning" variant="gradient" label={false} />
          <SuiProgress value={66} color="info" variant="gradient" label={false} />
          <SuiProgress value={100} color="success" variant="success" label={false} />
          <SuiProgress value={100} color="error" variant="error" label={false} />
