...

{
  ...
  if (node.accepted) {if (user?.email != node.acceptedBy) {denyActions = true}};
  if (node.canceled) {if (user?.email != node.canceledBy) {denyActions = true}};
  if (node.sold) {if (user?.email != node.soldBy) {denyActions = true}};
  if (node.pending) { denyActions = true };
