...
const { id, pending, accepted, acceptedBy, acceptedAt, sold, soldBy, soldAt, canceled, canceledBy, canceledAt, canceledWhy } = e ;
  ...
  const AcceptOrder = async ({ id, pending, accepted, acceptedBy, acceptedAt, sold, soldBy, soldAt, canceled, canceledBy, canceledAt, canceledWhy }) => {

    updateOrder({id, accepted: true, acceptedBy: user?.email, acceptedAt: datetime, pending: false})
