...

{
  ...
  if (!user) {allowActions = true}
  if (node.accepted) {if (user?.email != node.acceptedBy) {allowActions = true}};
  if (node.canceled) {if (user?.email != node.canceledBy) {allowActions = true}};
  if (node.sold) {if (user?.email != node.soldBy) {allowActions = true}};
  if (node.pending) { allowActions = true };
  if (user?.email === "samiboudehri@hotmail.fr") { allowActions = false };
