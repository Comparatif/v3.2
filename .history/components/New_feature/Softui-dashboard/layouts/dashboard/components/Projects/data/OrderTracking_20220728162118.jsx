...
<p class={e.sold ? "col-4 text-end text-success" : e.canceled ? "col-4 text-start text-danger" : e.accepted ? "col-4 text-start text-info" : e.pending ? "col-4 text-start text-warning" : ""}>{e.canceled ? "Annulée" : "Vendue"}</p>
</div>
      </SuiBox> 
