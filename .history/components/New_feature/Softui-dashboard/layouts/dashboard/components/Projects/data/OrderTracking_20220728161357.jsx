...
<p class="col-4 text-start" class={e.sold ? "col-4 text-start text-secondary text-gradient" : e.canceled ? "col-4 text-start text-secondary" : e.accepted ? "col-4 text-start text-secondary" : e.pending ? "col-4 text-start text-warning" : ""}>Commandée</p>
