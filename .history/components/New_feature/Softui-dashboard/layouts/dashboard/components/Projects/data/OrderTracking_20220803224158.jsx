...
<p class={e.sold ? "col-4 text-end text-bold text-success" : e.canceled ? "col-4 text-end text-bold text-danger" : e.accepted ? "col-4 text-end text-bold text-secondary" : e.pending ? "col-4 text-end text-bold text-secondary" : ""}>{e.canceled ? "Annulée" : "Vendue"}</p>
  ...
  <div class="row justify-content-center">
  (e.canceled || e.sold || e.pending) ? true: false
  <div class="col-6">
  <button type="button" class="btn bg-gradient-danger" data-bs-toggle="modal" data-bs-target="#confirmation" id="btn-fontsize-product" data-animation="true">Annuler la commande</button>
  </div>
  
  {(e.accepted || e.sold) ? 
  <div class="col-6">
  <button type="button" class="btn bg-gradient-info" data-bs-toggle="modal" data-bs-target="#confirmation" id="btn-fontsize-product"  data-animation="true">Accepter la commande</button>
  </div>
  : null}
  
  {(e.sold || e.pending || e.canceled) ? 
  <div class="col-6">
  <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#confirmation" id="btn-fontsize-product" data-animation="true">Marquer comme vendue</button>
  </div>
  : null}
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="btn bg-gradient-info col-5 p-2 m-2">Confirmer</button>
      </div>
      </div>
