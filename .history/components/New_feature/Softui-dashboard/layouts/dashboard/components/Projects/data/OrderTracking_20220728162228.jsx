...
<p class={e.sold ? "col-4 text-end text-bold text-success" : e.canceled ? "col-4 text-end text-danger" : e.accepted ? "col-4 text-end text-info" : e.pending ? "col-4 text-end text-warning" : ""}>{e.canceled ? "Annulée" : "Vendue"}</p>
</div>
      </SuiBox> 
