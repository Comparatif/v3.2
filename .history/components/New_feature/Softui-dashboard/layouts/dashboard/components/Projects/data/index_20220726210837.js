...
export default function data() {
  ...
  const heure = e.createdAt.split('T')[1].split('.')[0]
    ...
    Suivi: (
      ...
      <SuiProgress value={e.pending ? 33 : e.accepted ? 66 : e.sold ? 100 : e.canceled ? 100 : 0} 
      color={e.pending ? "warning" : e.accepted ? "info" : e.sold ? "success" : e.canceled ? "error" : "secondary"} variant="gradient" label={false} />
