...

{
  ...
  if (node.accepted) {if (user?.email != node.acceptedBy) {showBlur = true}};
  if (node.canceled) {if (user?.email != node.canceledBy) {showBlur = true}};
  if (node.sold) {if (user?.email != node.soldBy) {showBlur = true}};
  if (node.pending) { showBlur = true };
