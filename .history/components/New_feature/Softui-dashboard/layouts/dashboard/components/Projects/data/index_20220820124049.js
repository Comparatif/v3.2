...
export default function data() {
  const { loading, data, error, fet} = useQuery(QueryOrders, {variables: {
    first:2,
  }});

    const filteredData = data?.orders.map((e)=> Object.assign({Boutiques: e.vendeurs, Prix: e.product_price},{}))
