...
export const Cancel = ({loading, e, CancelOrder}) => {
  ...
  <select onChange={(e)=> setData({
    ...
    className={data.cancelWhy != '' ? "form-control is-valid" : "form-control is-invalid" : "form-control"} name="choices-button-city" id="choices-button-city" placeholder="Wilaya">
