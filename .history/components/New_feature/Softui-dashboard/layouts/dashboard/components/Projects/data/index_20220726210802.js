  ...
  const heure = e.createdAt.split('T')[1].split('.')[0]
    ...
    Suivi: (
      <SuiBox width="8rem" textAlign="left">
        {
          e.pending ? "warning" : e.accepted ? "info" : e.sold ? "success" : e.canceled ? "error" : "secondary"
          <SuiProgress value={e.pending ? 33 : e.accepted ? 66 : e.sold ? 100 : e.canceled ? 100 : 0} color="warning" variant="gradient" label={false} />
          <SuiProgress value={66} color="info" variant="gradient" label={false} />
          <SuiProgress value={100} color="success" variant="gradient" label={false} />
          <SuiProgress value={100} color="error" variant="gradient" label={false} />
