...
<p class={e.sold ? "col-4 text-center text-success" : e.canceled ? "col-4 text-center text-danger" : e.accepted ? "col-4 text-start text-info" : e.pending ? "col-4 text-start text-secondary" : ""}>Acceptée</p>
