...
export const Cancel = ({loading, e, CancelOrder}) => {
  ...
  <select onChange={(e)=> setData({
    ...
    className={data ? "form-control is-valid" : isOrderTrigger && !isCityCompliant ? "form-control is-invalid" : "form-control"} name="choices-button-city" id="choices-button-city" placeholder="Wilaya">
