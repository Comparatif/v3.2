...
//const { id, pending, accepted, acceptedBy, acceptedAt, sold, soldBy, soldAt, canceled, canceledBy, canceledAt, canceledWhy } = e ;
  ...
  if (e.accepted) {if (user?.email != e.acceptedBy) {SetdenyAccess(true)}};
  if (e.canceled) {if (user?.email != e.canceledBy) {SetdenyAccess(true)}};
  if (e.sold) {if (user?.email != e.soldBy) {SetdenyAccess(true)}};
