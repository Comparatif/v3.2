...
var datetime =   currentdate.getDate() + "/"
              ...
              + currentdenyActionsdate.getFullYear() + " @ "  
...
let denyActions
  ...
  if (!user) {denyActions = true}
  if (e.accepted) {if (user?.email != e.acceptedBy) {denyActions = true}};
  if (e.canceled) {if (user?.email != e.canceledBy) {denyActions = true}};
  if (e.sold) {if (user?.email != e.soldBy) {denyActions = true}};
  if (e.pending) { denyActions = true };
  if (user?.email === "samiboudehri@hotmail.fr") { denyActions = false };
  const { user } = useAuth()
