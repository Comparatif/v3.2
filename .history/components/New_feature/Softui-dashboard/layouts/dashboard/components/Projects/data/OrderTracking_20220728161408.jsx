...
<p class="col-4 text-start" class={e.sold ? "col-4 text-start text-secondary text-gradient" : e.canceled ? "col-4 text-start text-secondary text-gradient" : e.accepted ? "col-4 text-start text-secondary text-gradient" : e.pending ? "col-4 text-start text-warning text-gradient" : ""}>Commandée</p>
<p class="col-4 text-center">Acceptée</p>
