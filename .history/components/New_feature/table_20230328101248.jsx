...
import React, { useEffect , useContext, useState, useRef, forwardRef, forwardRef} from 'react'
...
<SearchkitProvider key={a+1} client={new SearchkitClient()}>
  <Ligne ref={childRef} id={a+1} SearchState={SearchState} 
...
return(
  ...
  <div className="table-responsive table_height">
    <button onClick={() => {childRef.current.getAlert(); handleDownloadExcel(excelData)}}> Export excel </button>
