...
return(
 ...
 <h6 className="mt-1">Dernière Mise a Jour : <bold style={{color: "green"}}>29/03/2023</bold></h6>
 </div>
 <hr className="vertical dark"/>
 </div>
 <div className="col-md-4 position-relative">
 <div className="p-1 text-center">
 <h6 className="mt-1" >Abonnement fin : <bold style={{color: "green"}}>29/03/2024</bold></h6>
 </div>
 <hr className="vertical dark"/>
 </div>
 <div className="col-md-4">
 <div className="testrow p-1 text-center justify-content-center">
 <h6 className="mt-1" >Export Excel: </h6><button className="btn btn-sm  bg-gradient-success btn-round mb-0 mx-2 mt-2 mt-md-0 px-3" onClick={() => {handleDownloadExcel(excelData)}}>Télécharger</button>
 </div>
 </div>
 </div>
 </div>
...
<a href="/downloads/Offres-Commerciales-Comparatifdz-FR.pdf" target="_blank"><button type="button" className="btn btn-block btn-info mb-1" data-animation="true">S'abonner maintenant</button></a>
