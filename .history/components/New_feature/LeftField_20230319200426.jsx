...
export const LeftField = ({sss, data, isOn, toggleIsOn, setQuery, liste, IndexChange, id, SearchState}) => 
...
{ShowSearchBar ?
<AutoCompleteText_ligne sss={sss} id={id} api={api} SearchState={SearchState} toggleIsOn={toggleIsOn} setQuery={setQuery} items={liste} index={IndexChange}/>
