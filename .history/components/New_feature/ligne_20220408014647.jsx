          ...
          {data?.results?.hits?.items.slice(0,1).map((hit)=>
            {
              ...
              isOn ?
                <td class="col-lg-3 col-xl-3 col-md-3 col-sm-3 col-3 mb-2 px-1">
                
                <div class="d-flex px-2 py-1">
                <AutoCompleteText_ligne onMouseOver={()=> toggleIsOn()} api={api} toggleIsOn={toggleIsOn} setQuery={setQuery} items={liste} index={IndexChange}/>
                ...
                <a style={{cursor : "pointer"}} onMouseOver={()=> toggleIsOn()}>
