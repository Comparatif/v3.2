...
data?.results.hits.items.map((hit) => {
    ...
    return(
        ...
        <td key={cle} className="results_ligne border-radius-lg move-on-hover shadow">
      ...
      <a href={shop_website}>
      <img  className="img-fluid border-radius-2xl " id="img-width" src={vendeurs_image} alt={vendeurs}/>
      </a>
