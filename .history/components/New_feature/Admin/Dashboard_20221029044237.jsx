...
const Dashboard = () => {
    ...
    return(
        <>
        <div className="min-height-300 bg-gradient-info position-absolute w-100"></div>
        <aside className="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
          <div className="sidenav-header">
            ...
            <a className="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank" rel="noreferrer">
              <img src="/argon-dashboard-master/assets/img/logo-ct-dark.png" className="navbar-brand-img h-100" alt="main_logo"/>
              ...
              <li className="nav-item">
                <a className="nav-link active" href="../pages/dashboard.html">
                  <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i className="ni ni-tv-2 text-info text-sm opacity-10"></i>
                  </div>
          ...
          <div className="sidenav-footer mx-3 ">
            <div className="card card-plain shadow-none" id="sidenavCard">
              <img className="w-50 mx-auto" src="/argon-dashboard-master/assets/img/illustrations/icon-documentation.svg" alt="sidebar_illustration"/>
            ...
            <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/argon-dashboard" target="_blank" rel="noreferrer" className="btn btn-dark btn-sm w-100 mb-3">Documentation</a>
            <a className="btn btn-info bg-gradient-info btn-sm mb-0 w-100" href="https://www.creative-tim.com/product/argon-dashboard-pro?ref=sidebarfree" type="button">Upgrade to pro</a>
          </div>
        </aside>
                    ...
                    <ul className="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                        ...
                        <a className="dropdown-item border-radius-md" href="javascript:;">
                          <div className="d-flex py-1">
                            <div className="my-auto">
                              <img src="/argon-dashboard-master/assets/img/team-2.jpg" className="avatar avatar-sm  me-3 "/>
                            </div>
                      ...
                      <li className="mb-2">
                        <a className="dropdown-item border-radius-md" href="javascript:;">
                          <div className="d-flex py-1">
                            <div className="my-auto">
                              <img src="/argon-dashboard-master/assets/img/small-logos/logo-spotify.svg" className="avatar avatar-sm bg-gradient-dark  me-3 "/>
                            </div>
                            <div className="d-flex flex-column justify-content-center">
                              <h6 className="text-sm font-weight-normal mb-1">
                    ...
                    <div className="row">
                      <div className="col-8">
                        <div className="numbers">
                          <p className="text-sm mb-0 text-uppercase font-weight-bold">CA Comparatifdz</p>
                ...
                <div className="card card-carousel overflow-hidden h-100 p-0">
                  <div id="carouselExampleCaptions" className="carousel slide h-100" data-bs-ride="carousel">
                    <div className="carousel-inner border-radius-lg h-100">
                      <div className="carousel-item h-100 active" style={{backgroundImage: `url(${'/argon-dashboard-master/assets/img/carousel-1.jpg'})`,backgroundSize: "cover"}}>
                      ...
                      <div className="carousel-item h-100" style={{backgroundImage: `url(${'/argon-dashboard-master/assets/img/carousel-2.jpg'})`,backgroundSize: "cover"}}>
                        <div className="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                          <div className="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                      ...
                      <div className="carousel-item h-100" style={{backgroundImage: `url(${'/argon-dashboard-master/assets/img/carousel-3.jpg'})`,backgroundSize: "cover"}}>
                        <div className="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                          <div className="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                ...
                <div className="row align-items-center justify-content-lg-between">
                  <div className="col-lg-6 mb-lg-0 mb-4">
                    <div className="copyright text-center text-sm text-muted text-lg-start">
                      © 
                      {useEffect(()=>(new Date().getFullYear()))}
            ...
            <div className="card-body pt-sm-3 pt-0 overflow-auto">
              ...
              <a href="javascript:void(0)" className="switch-trigger background-color">
                <div className="badge-colors my-2 text-start">
                  <span className="badge filter bg-gradient-info active" data-color="info" onclick="sidebarColor(this)"></span>
              ...
              <div className="d-flex">
                <button className="btn bg-gradient-info w-100 px-3 mb-2 active me-2" data-className="bg-white" onclick="sidebarType(this)">White</button>
                <button className="btn bg-gradient-info w-100 px-3 mb-2" data-className="bg-default" onclick="sidebarType(this)">Dark</button>
              </div>
              ...
              <div className="w-100 text-center">
                ...
                <a href="https://twitter.com/intent/tweet?text=Check%20Argon%20Dashboard%20made%20by%20%40CreativeTim%20%23webdesign%20%23dashboard%20%23bootstrap5&amp;url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fargon-dashboard" className="btn btn-dark mb-0 me-2" target="_blank" rel="noreferrer">
                  <i className="fab fa-twitter me-1" aria-hidden="true"></i> Tweet
                </a>
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/argon-dashboard" className="btn btn-dark mb-0 me-2" target="_blank" rel="noreferrer">
        ...
        {useEffect(()=>
            ...
            {var ctx1 = document.getElementById("chart-line").getContext("2d");
                ...
                var win = navigator.userAgentData.platform.indexOf('Win') > -1;
