...
/* La Barre de recherche */
  ...
  const sss = SearchState?.split("##!;#2")[id-1]
  console.log({"id": id})
  console.log({"searchstring": sss})
  ...
  useEffect(()=> {
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              CheckRelevance ? <> <LeftField sss={}id={id} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
