...
const [triggerExtract, setTriggerExtract] = (1)
...
<SearchkitProvider key={a+1} client={new SearchkitClient()}>
  <Ligne id={a+1} SearchState={SearchState} excelData={excelData} setExcelData={setExcelData} />
</SearchkitProvider>)
