...
export const LeftField = ({data, isOn, toggleIsOn, setQuery, liste, IndexChange, id}) => 
...
<a style={{cursor : "pointer"}} data-bs-toggle="modal" data-bs-target={"#" + cle + "-img"}>
  <img src={product_imagelinks} class="avatar avatar-sm"/>
  </a>
</div>
<div class="d-flex flex-column col-9 justify-content-center me-1">
<a style={{cursor : "pointer"}} onClick={()=> toggleIsOn()} >
  ...
  <div class='col-lg-2 col-md-2 col-sm-2 col-2 mx-2 justify-content-end p-0'>


            <Facets class="facet_ligne" id={id} data={data?.results}/>
