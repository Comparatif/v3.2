...
<a style={{cursor : "pointer"}} onClick={()=> toggleIsOn()} >
  ...
  <div className='col-lg-2 col-md-2 col-sm-2 col-2 mx-2 mt-1 justify-content-end p-0'>
            ...
            <div class="row">
            <div class="col-6 p-0">
            <button id="btn-fontsize" className="btn bg-gradient-warning mt-1 mb-0 p-0 py-1 col-6" type="button" data-bs-toggle="offcanvas" data-bs-target={id ? ("#"+ 'id' + id) : "canvas"} aria-controls="offcanvasScrolling">T</button>
            </div>
            <div class="col-6 p-0">
            <button id="btn-fontsize" className="btn bg-gradient-warning mt-1 mb-0 p-0  col-6" type="button" data-bs-toggle="offcanvas" data-bs-target={id ? ("#"+ 'id' + id) : "canvas"} aria-controls="offcanvasScrolling">T</button>
            </div>
