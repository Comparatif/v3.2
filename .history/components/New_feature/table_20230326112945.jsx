...
//exporter sur excel
const lignes = document.evaluate("//*[@name='q']", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
...
return(
  ...
  <div className="table-responsive table_height">
    ...
    <table className="table align-items-center mb-0" ref={tableRef} >
