...
/* La Barre de recherche */
    ...
    const RelevanceSearch = <> <Resultats data={data}/> {api.setSortBy('relevance')} {api.search()};</>
    const PriceSearch = <><Resultats data={data}/> {api.setSortBy('prix_croissant')}</>
    ...
    return(
            ...
            <div class='col-lg-1 col-md-2 col-sm-2 col-2 m-0 p-0'>
            <Facets data={data?.results}/>
            </div>
            {loading ? LoadingLogo : CheckIfZeroResults ? 


              CheckRelevance ? <p>pas de résultats</p> : 

              RelevanceSearch : PriceSearch
