...
<div class="col-md-4">
<div class="p-1 text-center">
<h6 class="mt-1" >Exporter</h6><button class="btn btn-sm  bg-gradient-success btn-round mb-0 mx-4 mt-2 mt-md-0" onClick={() => {handleDownloadExcel(excelData)}}> Export Excel </button>
</div>
</div>
</div>
</div>
