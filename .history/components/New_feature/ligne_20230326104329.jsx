  ...
  useEffect(()=> {
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              CheckRelevance ? <tr> <LeftField sss={sss} id={id} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <p>Pas de Résultats</p></tr> : 
              
              
              
              
              
              <tr> <LeftField sss={sss} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <Resultats data={data}/>{api.setSortBy('relevance')} {api.search()}</tr> : 
              
              
              <tr><LeftField sss={sss} id={id} SearchState={SearchState} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <Resultats data={data}/>{api.setSortBy('prix_croissant')}</tr>}
