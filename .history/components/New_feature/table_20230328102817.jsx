...
return(
  ...
  <div className="table-responsive table_height">
    <button onClick={() => {getData(); handleDownloadExcel(excelData)}}> Export excel </button>
    <table className="table align-items-center mb-0" >
      
      <tbody>
        <div onClick={()=> {setExcelData(excelData.splice(id-1, 0, list1))}} >1 </div>
        <div onClick={()=> {setExcelData(excelData.splice(id-1, 0, list1))}}> 2 {setExcelData(excelData.splice(id-1, 0, list1))}</div>
        <div onClick={()=> {setExcelData(excelData.splice(id-1, 0, list1))}}> 3 {setExcelData(excelData.splice(id-1, 0, list1))}</div>
      {elements}
