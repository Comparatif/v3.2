...
/* La Barre de recherche */
    ...
    return(
           ...
           <button onClick={()=> {api.setSortBy('prix_croissant'); api.search()}}></button>
            ...
            {loading ? LoadingLogo : CheckIfZeroResults == 0 ? <> <Resultats data={data}/> {api.setSortBy('relevance')} {api.search()};</> : 
              
              
              <><Resultats data={data}/> {api.setSortBy('prix_croissant')} {api.search()}</>}
