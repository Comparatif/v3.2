...
function handlePDF () {
  const pdf =sortedData.forEach(sub => {
    '\n'.join(' '.join(sub)
  });
  
  const pdf = '\n'.join(' '.join(sub) forEach sub in sortedData)
  doc.text(20, 20, 'Hello landscape world!'); doc.save('sample-file.pdf')
...
return(
  ...
  <div className="table-responsive table_height">
    <button class="btn btn-sm bg-gradient-primary btn-round mb-0 mx-5 mt-2 mt-md-0" onClick={() => {handleDownloadExcel(excelData)}}> Export Excel </button>
    <button class="btn btn-sm bg-gradient-primary btn-round mb-0 mx-5 mt-2 mt-md-0" onClick={() => {}}  > Export PDF </button>
