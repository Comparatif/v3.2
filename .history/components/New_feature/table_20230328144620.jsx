...
function handlePDF () {
  ...
  doc.text(20, 20, pdf); doc.save('sample-file.pdf')
...
return(
  ...
  <div className="table-responsive table_height">
    <button class="btn btn-sm bg-gradient-primary btn-round mb-0 mx-5 mt-2 mt-md-0" onClick={() => {handleDownloadExcel()}}> Export Excel </button>
    <button class="btn btn-sm bg-gradient-primary btn-round mb-0 mx-5 mt-2 mt-md-0" onClick={() => {handlePDF}}  > Export PDF </button>
