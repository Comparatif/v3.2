...
/* La Barre de recherche */
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              <> <LeftField id={id} SearchState) data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
              <Resultats data={data}/> {api.setSortBy('relevance')} {api.search()};</> : 
              
              
              <><LeftField id={id} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
