    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner border-radius-sm">
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="/img/Offres-commerciales/fr/1.png" alt="Second slide" />
        </div>
        <div class="carousel-item">
          <img class="d-block w-100" src="/img/Offres-commerciales/fr/1.png" alt="Third slide" />
        </div>
      </div>
