                  ...
                  <div className="card-body pt-1">
                    <div className="row">
                      ...
                      <div className="col-md-12 pe-2 mb-3">
                        ...
                        value={data.password}
                        className={Confirmation ? "form-control is-valid" : isTrigger ? "form-control is-valid" : "form-control is-invalid"} type="password" placeholder="Mot de passe" />
                      </div>
                      <div className="col-md-12 pe-2 mb-3">
                    ...
                    <div className="row">
                      <div className="col-md-4 justify-content-end ms-auto">
                        ...
                        <a style={{cursor: "pointer"}} onClick={()=> setValidity(Confirmation)} className="mt-1 text-sm text-small text-center" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#modal-form-login">Se connecter</a>
                      </div>
                      </div>
                    </div>
