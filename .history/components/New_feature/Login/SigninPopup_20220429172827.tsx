                  ...
                  <div className="card-body pt-1">
                    ...
                    <div className="row">
                      <div className="col-md-4 justify-content-end ms-auto">
                        ...
                        type={Confirmation ? "submit" : "button"} onClick={()=> Confirmation ? setTrigger(false) setTrigger(true)} className={Confirmation ? "btn btn-round bg-gradient-info mb-0" : "btn btn-round bg-gradient-info mb-0"}>Créer un compte</button>
                        <a style={{cursor: "pointer"}} className="mt-1 text-sm text-small text-center" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#modal-form-login">Se connecter</a>
                      </div>
                      </div>
                    </div>
