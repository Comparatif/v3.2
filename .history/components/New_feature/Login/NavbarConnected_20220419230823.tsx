                ...
                <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div className="d-none d-lg-block">
                    ...
                    <div className="row ps-3">
                      <span className="col-9" >Composants PC</span><img src="/img/custom/info.svg" className={IsComposantsSelected ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right"/>
                      </div>
                    </a>
