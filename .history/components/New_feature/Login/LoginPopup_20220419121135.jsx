              ...
              <div class="col-lg-5 position-relative bg-cover px-0" style={{backgroundImage: "url(" + "/img/curved-images/curved5.jpg" + ")"}}>
                ...
                <div class="z-index-2 text-center d-flex h-100 w-100 d-flex m-auto justify-content-center">
                  ...
                  <div class="p-5 ps-sm-8 position-relative text-left my-auto z-index-2">
                    ...
                    <div class="mt-4">
                      <button href="" type="button" class="btn btn-icon-only btn-link text-white btn-lg mb-0" data-toggle="tooltip" data-placement="bottom" data-original-title="Log in with Facebook" data-bs-original-title="" title="">
