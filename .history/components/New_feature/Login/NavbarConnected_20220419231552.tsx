...
{user ? 
                ...
                <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  ...
                  <div className="d-lg-none">
                    ...
                    <a className="dropdown-item border-radius-md" >
                    <div className="row ps-3"> 
                    <span className="col-9" >Déconnexion</span><img  src="/img/custom/info.svg" className="col-3" style={{maxHeight: "22px"}} title=""  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="bottom" data-container="body" data-animation="true"/>
                    </div>
                    </a>
