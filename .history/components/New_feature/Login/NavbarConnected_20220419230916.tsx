...
{user ? 
                ...
                <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div className="d-none d-lg-block">
                    ...
                    <a  className="">
                    <div className="row ps-3">
                      <span className="col-9" >Abonnement</span><img src="/img/custom/info.svg" className="" title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" />
                      </div>
                    </a>
