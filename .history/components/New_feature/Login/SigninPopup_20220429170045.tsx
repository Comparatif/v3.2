                  ...
                  <div className="card-body pt-1">
                    <div className="row">
                      ...
                      <div className="col-md-12 pe-2 mb-3">
                        ...
                        value={data.password}
                        className={Confirmation ? "form-control is-valid" : isTrigger && !Confirmation ? "form-control is-valid" : "form-control is-invalid"} type="password" placeholder="Mot de passe" />
                      </div>
                      <div className="col-md-12 pe-2 mb-3">
