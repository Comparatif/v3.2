...
{user ? 
              ...
              <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center text-bold" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                Connexion
