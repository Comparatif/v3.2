...
return(
    ...
    <div class="modal-body p-0">
          ...
          <div class="card overflow-hidden">
            <div class="row">
              <div class="col-lg-7">
                <form onSubmit={handleSignup} class="p-3" id="signup-Form">
                  ...
                  <div class="card-body pt-1">
                    <div class="row">
                      <div class="col-md-12 pe-2 mb-3">
                        ...
                        class="form-control" placeholder="Adresse e-mail" type="email" id="signup-email"/>
                      </div>
                      <div class="col-md-12 pe-2 mb-3">
                      ...
                      <div class="col-md-12 pe-2 mb-5">
                        ...
                        class="form-control" type="password" placeholder="Mot de passe" id="signup-password"/>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 text-right ms-auto">
                        ...
                        type="submit" class="btn btn-round bg-gradient-info mb-0">Créer un compte</button>
                      </div>
                    </div>
                  </div>
                </form>
