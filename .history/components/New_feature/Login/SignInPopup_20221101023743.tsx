                  ...
                  <div className="card-body pt-1">
                    ...
                    <div className="row">
                      <div className="col-md-4 justify-content-end ms-auto">
                        ...
                        type={Confirmation ? "submit" : "button"} onClick={()=> Confirmation ? setTrigger(false) : setTrigger(true)} className="btn btn-round bg-gradient-info mb-0">Créer un compte</button>
              ...
              <div className="col-lg-5 position-relative bg-cover px-0" style={{backgroundImage: "url(" + "/img/curved-images/curved5.jpg" + ")"}}>
                ...
                <div className="z-index-2 text-center d-flex h-100 w-100 d-flex m-auto justify-content-center">
                  ...
                  <div className="p-5 ps-sm-8 position-relative text-left my-auto z-index-2">
                    ...
                    <div className="mt-4">
                    <a href="https://www.facebook.com/Comparatifdz"  >
