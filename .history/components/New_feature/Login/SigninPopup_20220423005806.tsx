              ...
              <div className="col-lg-7">
                <form onSubmit={handleSignup} className="p-3" id="signup-Form">
                  ...
                  <div className="card-body pt-1">
                    ...
                    <div className="row">
                      <div className="col-md-6 justify-content-end ms-auto">
                        <div>
                        <button 
                        ...
                        <a style={{cursor: "pointer"}} className="mb-0 text-small" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#modal-form-login">Se connecter</a>
                      </div>
