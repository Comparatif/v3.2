...

{
  ...
  const [isTrigger, setTrigger] = useState(null)
                  ...
                  <div className="card-body pt-1">
                    <div className="row">
                      ...
                      <div className="col-md-12 pe-2 mb-3">
                        ...
                        value={data.password}
                        className={Confirmation ? "form-control is-valid" : isTrigger && !Confirmation ? "form-control is-invalid" : "form-control is-invalid"} type="password" placeholder="Mot de passe" />
                      </div>
                      <div className="col-md-12 pe-2 mb-3">
                        ...
                        className={Confirmation ? "form-control is-valid" :"form-control"} type="password" placeholder="Mot de passe" />
                      </div>
                      <p className="text-warning m-0">{data.signupError}</p>
                      
                    </div>
                    <div className="row">
                      <div className="col-md-4 justify-content-end ms-auto">
                        <div className="row justify-content-center">
                        <button 
                        
                        type={Confirmation ? "submit" : null} className={Confirmation ? "btn btn-round bg-gradient-info mb-0" : "btn btn-round bg-gradient-info mb-0 disabled"}>Créer un compte</button>
                        <a style={{cursor: "pointer"}} onClick={()=> setTrigger(Confirmation)} className="mt-1 text-sm text-small text-center" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#modal-form-login">Se connecter</a>
                      </div>
                      </div>
                    </div>
