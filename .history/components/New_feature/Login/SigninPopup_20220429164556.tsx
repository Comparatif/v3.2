                  ...
                  <div className="card-body pt-1">
                    ...
                    <div className="row">
                      <div className="col-md-4 justify-content-end ms-auto">
                        ...
                        <a style={{cursor: "pointer"}} onClick={()=> setValid(tr)} className="mt-1 text-sm text-small text-center" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#modal-form-login">Se connecter</a>
                      </div>
                      </div>
                    </div>
