...
<h6 class="mt-1">Dernière Mise a Jour : <bold style={{color: "red"}}>29/03/2023</bold></h6>
</div>
<hr class="vertical dark"/>
</div>
<div class="col-md-4 position-relative">
<div class="p-1 text-center">
<h6 class="mt-1" style={{color: "red"}} >Abonnement : 29/03/2024</h6>
</div>
<hr class="vertical dark"/>
</div>
<div class="col-md-4">
...
<h5 class="mt-1">Pages</h5>
    ...
    <button class="btn btn-sm  bg-gradient-success btn-round mb-0 mx-4 mt-2 mt-md-0" onClick={() => {handleDownloadExcel(excelData)}}> Export Excel </button>
