...
const getData = (data, id, list1, list2) => {setExcelData(excelData.splice(id-1, 0, list1))}
  ...
  <div className="table-responsive table_height">
    ...
    <table className="table align-items-center mb-0" >
      ...
      <tbody>
        ...
        <div onClick={()=> {setExcelData(excelData.splice(id-1, 0, list1))}}> 2 </div>
        <div onClick={()=> {setExcelData(excelData.splice(id-1, 0, list1))}}> 3 </div>
      {elements}
