...
/* La Barre de recherche */
    ...
    const SearchStateString = SearchState?.split("##!;#2")[id-1]
    console.log({"id": id})
    console.log({"searchstring": SearchStateString})

    useEffect(()=> {
      api.setQuery(SearchStateString)
      api.search()
    },[])
    ...
    return(
            ...
            {loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              CheckRelevance ? <> <LeftField SearchStateStringid={id} data={data} isOn ={isOn} toggleIsOn={toggleIsOn} setQuery={setQuery} liste={liste} IndexChange={IndexChange} />
