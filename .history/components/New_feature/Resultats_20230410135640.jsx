...
data?.results.hits.items.map((hit, col) => {
    ...
    return(
      ...
      <a href={shop_website}>
      <img  className="img-fluid border-radius-lg img_white_background" id="img-width" src={vendeurs_image} onError={(e) => { e.target.src = '/img/custom/broken-image.png' }} onError={this.src='/img/custom/broken-image.png'} alt=""/>
      </a>
  ...
  <img id="img-width" src={vendeurs_image} onError={this.src='/img/custom/broken-image.png'} alt="" className="img-fluid border-radius-2xl img_white_background " style={{maxheight: "20px", objectFit: "scale-down", aspectRatio: "20/9"}}/>
  </a>
