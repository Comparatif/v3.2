...
data?.results.hits.items.map((hit, col) => {
  ...
  <img id="img-width" src={vendeurs_image} onError={()=> src='/img/custom/broken-image.png'} alt="" className="img-fluid border-radius-2xl img_white_background " style={{maxheight: "20px", objectFit: "scale-down", aspectRatio: "20/9"}}/>
  </a>
