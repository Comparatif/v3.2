...
data?.results.hits.items.map((hit, col) => {
    ...
    return(
        ...
        <td 
          ...
          key={cle} 
          className={isSelected.row === id && isSelected.col === col ? "results_ligne border-radius-xl shadow m-1 bg-gradient-info opacity-9"  :"results_ligne border-radius-xl shadow m-1" }
