...
data?.results.hits.items.map((hit) => {
  ...
  <ul className="dropdown-menu z-index-3" aria-labelledby={cle}>
    ...
    <img src="/img/custom/info.svg"/> Détails
      ...
      <small className="ms-1" id={stocks === 'Rupture de stock' ? "Rupture_de_stock" : "En_stock" }><strong>{stocks}</strong></small>

      <i class="fas fa-circle" style={{color: stocks === 'Rupture de stock' ? "red" : stocks?.includes("Stock") ? "green" : stocks?.includes("command") ? "orange" : "white" }}></i>
