...
export const LeftField = ({data, isOn, toggleIsOn, setQuery, liste, IndexChange, id, SearchState={SearchState}}) => 
...
{ShowSearchBar ?
<AutoCompleteText_ligne id={id} api={api} toggleIsOn={toggleIsOn} setQuery={setQuery} items={liste} index={IndexChange}/>
