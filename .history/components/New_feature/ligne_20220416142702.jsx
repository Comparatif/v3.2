...
/* La Barre de recherche */
    const ShowSearchBar = !isOn || api.getQuery() == ""
...
<ul class="dropdown-menu z-index-1" aria-labelledby={cle}>
  ...
  <img src="/img/custom/info.svg"/> Détails
    ...
    const NoResults = <h1>Aucun résultats, réessayez :(</h1>
    ...
    return(
          ...
          <tr>{
            ...
            loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              ( RelevanceAndZero ? <> {SearchBar} {NoResults} </> : RelevanceSearch ) :  <> {SearchBar}  {resultats} </>
