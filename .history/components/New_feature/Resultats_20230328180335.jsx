...
data?.results.hits.items.map((hit) => {
    ...
    return(
        ...
        <td 
          ...
          key={cle} 
          className="results_ligne border-radius-xl move-on-hover shadow mx-1 bg-cover " 
          style={{  
            backgroundImage: `url(${"/img/curved-images/curved5.jpg"})`
          }}>
    
        <div className="modal fade mask bg-gradient-info opacity-9" id={cle} tabIndex="-1" aria-labelledby={cle + "Label"} aria-hidden="true">
