...
<a href="https://www.maxframe.dz/cpu-amd-ryzen-5-5600x-3-7ghz" target="_blank" rel="noreferrer"><button type="button" class="btn bg-gradient-info mb-0 position-relative z-index-0 button-width" id="btn-fontsize-product" data-animation="true">Voir l'offre</button></a>



<a src={"/downloads/Offres-Commerciales-Comparatifdz-FR.pdf"} role="button" aria-pressed="true" className="btn btn-block btn-info mb-1">
