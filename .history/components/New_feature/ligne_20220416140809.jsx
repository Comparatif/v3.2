...
<ul class="dropdown-menu z-index-1" aria-labelledby={cle}>
  ...
  <img src="/img/custom/info.svg"/> Détails
    ...
    const AucunResultats = <td class="results_ligne">{SearchBar}<h1>Aucun résultats, réessayez :(</h1></td>
    const CheckIfZeroResultats = data?.results.summary.total == 0
          ...
          <tr>{
            ...
            { data?.results.summary.total == 0 ?
              ...
              AucunResultats
                ...
                :<>{api.setSortBy('relevance') && SearchBar && resultats}</>
