...
<ul class="dropdown-menu z-index-1" aria-labelledby={cle}>
  ...
  <img src="/img/custom/info.svg"/> Détails
    ...
    //useEffect(()=> previousData!= data && CheckIfZeroResults ? api.setSortBy('relevance') : "")
    ...
    return(
          ...
          return (
            ...
            CheckRelevance ? NoResults: RelevanceSearch  loading ? LoadingLogo : CheckIfZeroResults ? 
              
            CheckRelevance ? NoResults: RelevanceSearch  :  resultats
