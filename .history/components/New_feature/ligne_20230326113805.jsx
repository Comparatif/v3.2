...
/* La Barre de recherche */
  ...
  useEffect(()=> {
    ExcelTable.push([data?.results?.hits?.items.slice(0,1).map((hit)=> hit.fields.product_names), 
...
console.log(data?.results?.hits?.items.slice(0,1).map((hit)=> hit.fields.product_names), data?.results.hits.items.map((hit) => hit.fields.vendeurs))
