...
<a href="/downloads/Offres-Commerciales-Comparatifdz-FR.pdf" target="_blank"><button type="button" class="btn btn-block btn-info mb-1" id="btn-fontsize-product" data-animation="true">Voir l'offre</button></a>
