...
return(
  ...
  <div className="table-responsive table_height">
    ...
    <button class="btn btn-sm bg-gradient-primary btn-round mb-0 mx-5 mt-2 mt-md-0" onClick={() => {doc.text(20, 20, 'Hello landscape world!'); doc.save('sample')}}  > Export PDF </button>
