...
<ul class="dropdown-menu z-index-1" aria-labelledby={cle}>
  ...
  <img src="/img/custom/info.svg"/> Détails
    ...
    const NoResults = <tr>{LeftField} <td>Aucun résultats, réessayez :(</td></tr>
    ...
    const PertinenceSearch = <tr>{LeftField}  {resultats}</tr>
    ...
    return(
            ...
            loading ? LoadingLogo : CheckIfZeroResults ? 
              ...
              ( RelevanceAndZero ? <> {NoResults} </> : RelevanceSearch ) :  <> {PertinenceSearch} </>
