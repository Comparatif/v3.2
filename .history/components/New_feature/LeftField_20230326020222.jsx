...
<a className="pt-1" style={{cursor : "pointer"}} onClick={()=> toggleIsOn()} >
  ...
  <p className="text-xs text-secondary mb-0 mt-1">Tri: {CheckIfSorted == "prix_croissant" ? "Par Prix" : "Pertinence"}</p>
