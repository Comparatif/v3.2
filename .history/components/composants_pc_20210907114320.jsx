...
const Page = () => {
  ...
  return new bootstrap.Tooltip(tooltipTriggerEl)
    ...
    return (
      ...
      <meta property="og:description" content={data?.results.hits.items.slice(0,1).map((hit)=>"Prix le moins cher : " + price + " DA | "+ categories + " : "+ names + " | Marque : " + marques + " | Boutique : " +boutique)}/>
