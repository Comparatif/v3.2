              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <a class={cartItemsVar() == 'and' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage1} data-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-content="Affiche le prix le moins cher mais certains résultats peuvent ne pas apparaître.">
                      <span class="ps-3">Prix croissant</span>
                    </a>
                    <a class={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage2} data-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-content="Liste de résultats plus large cependant le tri par ordre de prix est désactivé">
                      <span class="ps-3">Pertinence</span> <img src="/img/custom/info.svg"/>
                    </a>
                  </div>
                  <div class="d-lg-none">
                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center px-0">
