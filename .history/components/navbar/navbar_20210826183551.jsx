              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <div class="row ps-3">
                      <span class="col-9">Pertinence</span> <img src="/img/custom/info.svg" class="col-3"  title="Affiche les résultats les plus pértinents (les prix ne seront pas classés par ordre croissant)."  trigger="" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                      </div>
                      </a>
