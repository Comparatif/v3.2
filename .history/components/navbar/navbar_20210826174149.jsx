              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <div class="row">
                      <span class="p-0 col-9 text-start">Prix croissant</span> <img src="/img/custom/info.svg" class="col-3" data-bs-original-title="Affiche les prix les moins chers (certains résultats peuvent ne pas apparaître)."  data-bs-toggle="tooltip" data-bs-placement="right"/>
                    </div>
                      </a>
