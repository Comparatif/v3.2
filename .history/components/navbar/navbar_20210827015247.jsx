              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  ...
                  <div class="d-lg-none">
                    ...
                    <span class="col-9">Prix croissant</span><img  src="/img/custom/info.svg" data-bs-original-title="Affiche les prix les moins chers (certains résultats peuvent ne pas apparaître)."  data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                    </div>
                    </a>
