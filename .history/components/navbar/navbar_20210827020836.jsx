              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <div class="row ps-3">
                      <span class="col-9" onClick={composants}>Composants PC</span><img src="/img/custom/more-info.png" class="col-3" title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-toggle="tooltip" data-bs-placement="right"/>
                      </div>
                    </a>
                    ...
                    <div class="row ps-3">
                      <span class="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/more-info.png" class="col-3" title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-toggle="tooltip" data-bs-placement="right" />
                      </div>
                    </a>
                    ...
                    <div class="row ps-3">
                      <span class="col-9 " onClick={reglage1}>Prix croissant</span> <img src="/img/custom/more-info.png" class="col-3" title="" data-bs-original-title="Affiche les prix les moins élevés (certains résultats peuvent ne pas apparaître)." data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                    </div>
                      </a>
                      
                    <a class={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div class="row ps-3">
                      <span class="col-9" onClick={reglage2}>Pertinence</span> <img src="/img/custom/more-info.png" class="col-3"  title="Affiche les résultats les plus pértinents (les prix ne seront pas classés par ordre croissant)."  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                      </div>
                      </a>
                  ...
                  <div class="d-lg-none">
                    ...
                    <a  class={Value == 'Composants_pc' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  >
                    <div class="row ps-3">
                      <span class="col-9" onClick={composants}>Composants PC</span><img src="/img/custom/more-info.png" class="col-3" style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                      </div>
                      </a>
                    ...
                    <a  class={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div class="row ps-3">
                    <span class="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/more-info.png" class="col-3" style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-toggle="tooltip" data-bs-placement="bottom" />
                    </div>
                    </a>
