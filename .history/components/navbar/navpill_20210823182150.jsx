...
<div class="nav-wrapper position-relative end-0">
   ...
   <a onClick={Liste}>
      <li class="nav-item" >
         <button type ="button" class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab"  role="tab" aria-controls="profile" aria-selected="true">
         Liste
         </button>
      </li>
      ...
      <a>
      <li class="nav-item" >
         <button type ="button" class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab"  role="tab" aria-controls="dashboard" aria-selected="false">
         Grille
         </button>
      </li>
      </a>
