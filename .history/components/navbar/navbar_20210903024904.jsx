...
export const NavBar = ({data}) => {
  ...
  const reglage1 = () => {cartItemsVar('and'); setValue(value); api.setSortBy(value); api.search();}
  const reglage2 = () => {cartItemsVar('or'); setValue(value); api.setSortBy(value); api.search();}
