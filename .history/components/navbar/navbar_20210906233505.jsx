...
//filters((id, type, lab, display, entries) => id === type)
  ...
  const composants = () => {window.location.pathname === "/" ? loca SetValue('Composants_pc'); SearchkitIndex('Composants_pc'); api.toggleFilter({identifier: "type", value: "Composants_pc"});api.removeFilter({identifier: "type", value: "Laptop"}); api.search();}
