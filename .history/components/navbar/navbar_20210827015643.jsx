              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  ...
                  <div class="d-lg-none">
                    ...
                    <a class={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div class="row ps-3">
                    <span class="col-9" onClick={reglage2}>Pertinence</span><img  src="/img/custom/info.svg" class="col-3" title="" data-bs-original-title="Affiche les résultats les plus pértinents (les prix ne seront pas classés par ordre croissant)."  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="bottom" data-container="body" data-animation="true"/>
                    </div>
                    </a>
