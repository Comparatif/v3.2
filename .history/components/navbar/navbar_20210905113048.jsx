...
//filters((id, type, lab, display, entries) => id === type)
  ...
  const laptop = () => {SetValue('Laptop'); SearchkitIndex('Laptop'); api.toggleFilter({identifier: "type", value: "Laptop"}); api.removeFilter({identifier: "type", value: "Laptop"}) ; api.search();}
