              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  ...
                  <div class="d-lg-none">
                    ...
                    <div class="row ps-3">
                      <span class="col-9">Composants PC</span><img src="/img/custom/info.svg" class="col-3" title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                      </div>
                      </a>
