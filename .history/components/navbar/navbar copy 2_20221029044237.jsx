  ...
  const reglage2 = () => {api.setSortBy('relevance'); cartItemsVar('or'); api.search();}
    ...
    return(
        ...
        <div className="container" >
          <a className="navbar-brand  text-white " href="https://comparatifdz.com" rel="tooltip" title="Comparateur de prix" data-placement="bottom" target="_blank" rel="noreferrer">
          Comparatif-dz 
          </a>
              ...
              <li className="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div className="d-none d-lg-block">
                    ...
                    <a  className={Value == 'Composants_pc' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  >
                    <div className="row ps-3">
                      <span className="col-9" onClick={composants}>Composants PC</span><img src="/img/custom/info.svg" className={Value == 'Composants_pc' ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right"/>
                      </div>
                    </a>
                    

                    
                    <a  className={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div className="row ps-3">
                      <span className="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/info.svg" className={Value == 'Laptop' ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" />
                      </div>
                    </a>
                  ...
                  <div className="d-lg-none">
                    ...
                    <a  className={Value == 'Composants_pc' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  >
                    <div className="row ps-3">
                      <span className="col-9" onClick={composants}>Composants PC</span><img src="/img/custom/info.svg" className={Value == 'Composants_pc' ?  "custom-image col-3" : "col-3"} style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                      </div>
                      </a>
                    ...
                    <a  className={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div className="row ps-3">
                    <span className="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/info.svg" className={Value == 'Laptop' ?  "custom-image col-3" : "col-3"} style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="bottom" />
                    </div>
                    </a>
