...
export const NavBar = ({data}) => {
  ...
  const composants = () => {SetValue('Composants_pc'); SearchkitIndex('Composants_pc'); api.toggleFilter({identifier: filter.identifier === "type", value: "Composants_pc"}); api.search();}
  const laptop = () => {SetValue('Laptop'); SearchkitIndex('Laptop'); api.toggleFilter({identifier: filter.identifier === "type", value: "Laptop"}); api.search();}
