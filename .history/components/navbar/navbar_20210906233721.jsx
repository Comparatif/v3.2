...
//filters((id, type, lab, display, entries) => id === type)
  ...
  const laptop = () => {window.location.pathname === "/" ? location.replace("/Algerie/informatique/Composants_pc") : SetValue('Laptop'); SearchkitIndex('Laptop'); api.toggleFilter({identifier: "type", value: "Laptop"}); api.removeFilter({identifier: "type", value: "Composants_pc"}) ; api.search();}
