...
export const NavBar = () => {
  ...
  const reglage2 = () => {cartItemsVar('or'); api.setSortBy('relevance'); api.search();}
    ...
    return(
        ...
        <div class="container" >
          <a class="navbar-brand  text-white " href="https://comparatifdz.vercel.app" rel="tooltip" title="Comparateur de prix" data-placement="bottom" target="_blank">
          Comparatif-dz 
          </a>
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <a class={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage2}>
                      <span class="ps-3">Précision élevée</span>
                    </a>
                  </div>
                  <div class="d-lg-none">
                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center px-0">
