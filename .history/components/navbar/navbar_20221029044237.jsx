...
import { Facets } from '../facet/facet.jsx';
import Link from 'next/link'
import { NavBarConnected } from '../New_feature/Login/NavbarConnected';




export const NavBar = ({data}) => {
//filters((id, type, lab, display, entries) => id === type)
  ...
  const IsComposantsSelected = api.isFilterSelected({
    identifier: "type",
    value: 'Composants_pc',
  })

  const IsLaptopSelected = api.isFilterSelected({
    identifier: "type",
    value: "Laptop",
  })
    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none navbar-transparent position-fixed">
        <div className="container" >
        <Link href="/">
          <a className="navbar-brand  text-white " rel="tooltip" title="Comparateur de prix" data-placement="bottom" >
          Comparatif-dz 
          </a>
          </Link>
          ...
          <div className="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-12 ps-lg-5" id="navigation">
            <ul className="navbar-nav navbar-nav-hover w-100">
              <li className="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div className="d-none d-lg-block">
                    ...
                    <a  className={IsComposantsSelected ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  >
                    <div className="row ps-3">
                      <span className="col-9" onClick={composants}>Composants PC</span><img src="/img/custom/info.svg" className={IsComposantsSelected ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right"/>
                      </div>
                    </a>
                    

                    
                    <a  className={IsLaptopSelected ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div className="row ps-3">
                      <span className="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/info.svg" className={IsLaptopSelected ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" />
                      </div>
                    </a>
                    ...
                    <a className={CheckIfSorted == "prix_croissant" ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  >
                    <div className="row ps-3">
                      <span className="col-9 " onClick={reglage1}>Prix croissant</span> <img src="/img/custom/info.svg" className={CheckIfSorted == "prix_croissant" ?  "custom-image col-3" : "col-3"} title="" data-bs-original-title="Affiche les prix les moins élevés (Pour garantir la qualité du comparateur, certains résultats peuvent ne pas apparaître)." data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                    </div>
                      </a>
                      
                    <a className={CheckIfSorted == "relevance" ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div className="row ps-3">
                      <span className="col-9" onClick={reglage2}>Pertinence</span> <img src="/img/custom/info.svg" className={CheckIfSorted == "relevance" ?  "custom-image col-3" : "col-3"}  title="Affiche les résultats les plus pértinents (Pour garantir la qualité du comparateur, les prix ne seront pas classés par ordre croissant)."  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                      </div>
                      </a>
                  ...
                  <div className="d-lg-none">
                    ...
                    <a  className={IsComposantsSelected ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  >
                    <div className="row ps-3">
                      <span className="col-9" onClick={composants}>Composants PC</span><img src="/img/custom/info.svg" className={IsComposantsSelected ?  "custom-image col-3" : "col-3"} style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                      </div>
                      </a>
                    ...
                    <a  className={IsLaptopSelected ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div className="row ps-3">
                    <span className="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/info.svg" className={IsLaptopSelected ?  "custom-image col-3" : "col-3"} style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="bottom" />
                    </div>
                    </a>
              ...
              <li className="nav-item dropdown dropdown-hover mx-2">
                <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuBlocks"  aria-expanded="false">
                  Smartphones
                  <img src="/img/down-arrow-white.svg" alt="down-arrow" className="arrow ms-1 d-lg-block d-none"/>
                  <img src="/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-1 d-lg-none d-block"/>
                </a>
              ...
              <li className="nav-item dropdown dropdown-hover mx-2">
                <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuDocs" aria-expanded="false">
                  Automobiles
                  <img src="/img/down-arrow-white.svg" alt="down-arrow" className="arrow ms-1 d-lg-block d-none"/>
                  <img src="/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-1 d-lg-none d-block"/>
                </a>
              ...
              <li className="nav-item my-auto ms-3 ms-lg-0">
                <a href="mailto:comparatif.algerie@gmail.com?subject = Feedback = Message" className="btn btn-sm  bg-white  btn-round mb-0 me-1 mt-2 mt-md-0">Contactez-nous</a>
              </li>
            </ul>
          </div>
        </div>
