                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <a class={cartItemsVar() == 'and' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage1} >
                      <span class="ps-3">Prix croissant</span> <img  src="/img/custom/info.svg" data-bs-original-title="Affiche le prix le moins cher mais certains résultats peuvent ne pas apparaître."  data-bs-toggle="tooltip"/>
                    </a>
