  ...
  var [tooltip, setTooltip] = useState(false);
    ...
    useEffect(() => {
      var myTooltip = tooltipRef.current
        var bsTooltip = bootstrap.Tooltip.getInstance(myTooltip)
      if (!bsTooltip) {

        // initialize Tooltip
        bsTooltip = new Tooltip(myTooltip, {autohide: false})
        // hide after init
        bsTooltip.hide()
        setTooltip(false)
      }
        ...
        // toggle
        tooltip ? bsTooltip.show() : bsTooltip.hide() }})
              ...
              <li className="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div className="d-none d-lg-block">
                    ...
                    <a  className={Value == 'Composants_pc' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  onClick={composants}>
                    <div className="row ps-3">
                      <span className="col-9">Composants PC</span><img src="/img/custom/info.svg" className="col-3" title="" data-bs-original-title="Active la recherche pour les Composants PC"  data-bs-toggle="tooltip" data-bs-placement="right"/>
                      </div>
                    </a>
                    

                    
                    <a  className={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={laptop}>
                    <div className="row ps-3">
                      <span className="col-9">Laptop & PC fixes</span><img src="/img/custom/info.svg" className="col-3" title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-toggle="tooltip" data-bs-placement="right"/>
                      </div>
                    </a>
                    ...
                    <a className={cartItemsVar() == 'and' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage1} >
                    <div className="row ps-3">
                      <span className="col-9 ">Prix croissant</span> <img src="/img/custom/info.svg" className="col-3" title="" data-bs-original-title="Affiche les prix les moins élevés (certains résultats peuvent ne pas apparaître)." data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                    </div>
                      </a>
                      
                    <a className={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage2}>
                    <div className="row ps-3">
                      <span className="col-9">Pertinence</span> <img src="/img/custom/info.svg" className="col-3"  title="Affiche les résultats les plus pértinents (les prix ne seront pas classés par ordre croissant)."  data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="right" data-container="body" data-animation="true" />
                      </div>
                      </a>
                  ...
                  <div className="d-lg-none">
                    ...
                    <a  className={Value == 'Composants_pc' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"}  onClick={composants}>
                      <span className="ps-3">Composants PC</span>
                    </a>
                    

                    
                    <a  className={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={laptop}>
                      <span className="ps-3">Laptop & PC fixes</span>
                    </a>
                    ...
                    <a className={cartItemsVar() == 'and' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage1}>
                      <span className="ps-3">Prix croissant</span><img  src="/img/custom/info.svg" data-bs-original-title="Affiche les prix les moins chers (certains résultats peuvent ne pas apparaître)."  data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                    </a>
                    <a className={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={reglage2}>
                      <span className="ps-3">Pertinence</span><img  src="/img/custom/info.svg" data-bs-original-title="Affiche les résultats les plus pértinents (les prix ne seront pas classés par ordre croissant)."  data-bs-toggle="tooltip" data-bs-placement="bottom"/>
                    </a>
                  </div>
                </div>
              </li>
