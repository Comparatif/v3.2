                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <div class="row justify-content-between">
                      <span class="ps-3">Prix croissant</span> <img src="/img/custom/info.svg" class="col-2" data-bs-original-title="Affiche les prix les moins chers (certains résultats peuvent ne pas apparaître)."  data-bs-toggle="tooltip" data-bs-placement="right"/>
                    </div>
                      </a>
