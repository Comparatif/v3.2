...
<div class="nav-wrapper position-relative end-0">
   ...
   <a class={cartItemsVar() == 'and' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={Liste} >
   <span class="ps-3">Prix croissant</span> <img src="/img/custom/info.svg"/>
 </a>
 <a class={cartItemsVar() == 'or' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} onClick={Grille}>
