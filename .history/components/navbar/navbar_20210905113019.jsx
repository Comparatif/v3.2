...
//filters((id, type, lab, display, entries) => id === type)
  ...
  const composants = () => {SetValue('Composants_pc'); SearchkitIndex('Composants_pc'); api.toggleFilter({identifier: "type", value: "Composants_pc"});api.toggleFilter({identifier: "type", value: "Composants_pc"}); api.search();}
  const laptop = () => {SetValue('Laptop'); SearchkitIndex('Laptop'); api.toggleFilter({identifier: "type", value: "Laptop"}); api.search();}
