              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <div class={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white row ps-3" : "dropdown-item border-radius-md row ps-3"}>
                    
                    <a onClick={laptop} class="col-9">
                      <span >Laptop & PC fixes</span>
                      </a>
                      
                      <img src="/img/custom/info.svg" class="col-3" title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-toggle="tooltip" data-bs-placement="right" />
                      </div>
