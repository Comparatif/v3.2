              ...
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  ...
                  <div class="d-lg-none">
                    ...
                    <a  class={Value == 'Laptop' ?  "dropdown-item border-radius-md bg-gradient-info text-white" : "dropdown-item border-radius-md"} >
                    <div class="row ps-3">
                    <span class="col-9" onClick={laptop}>Laptop & PC fixes</span><img src="/img/custom/info.svg" class="col-3" style={{maxHeight: "22px"}} title="" data-bs-original-title="Active la recherche pour les Laptop & PC fixes"  data-bs-toggle="tooltip" data-bs-placement="bottom" />
                    </div>
                    </a>
