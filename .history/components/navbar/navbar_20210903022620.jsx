...
export const NavBar = ({data}) => {
  ...
  const options =
    ...
    })),console.log(sortOption.id + "---" + sortOption.label) || []
  ...
  const reglage1 = () => {cartItemsVar('and'); setValue(value); api.setSortBy('prix_croissant'); api.search();}
  const reglage2 = () => {cartItemsVar('or'); setValue(value); api.setSortBy('relevance'); api.search();}
