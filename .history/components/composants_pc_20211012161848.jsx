    ...
    return (
      ...
      
      {
        ...
        
       {
        ...
        return( <>
      <title>{!names_bdd ? product_names : names_bdd} prix Algérie - Comparatif</title>
      
      <meta name="description" content={!names_bdd ? product_names : names_bdd + " prix Algérie | " + description1  + " | " + categories + " | " + "Meilleur prix : " + const product_prices = hit.fields.product_prices + " DA"}/>
 
      <link rel="canonical" href= {window.location.href} />
      <meta property="og:locale" content= "fr_FR" />
      <meta property="og:type" content= "article" />
      <meta property="og:title" content= {!names_bdd ? product_names : names_bdd +" prix Algérie - Comparatif"} />
      ...
      <meta property="og:description" content={!names_bdd ? product_names : names_bdd + " prix Algérie | " + description1  + " | " + categories + " | " + "Meilleur prix : " + price + " DA"}/>
