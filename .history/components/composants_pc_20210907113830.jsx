...
{data?.results.hits.items.slice(0,1).map((hit)=>
    ...
    return (
      ...
      <meta name="description" content={"Prix le moins cher : " + hit.fields.product_prices + " DA | "+ hit.fields.categories + " : "+ hit.fields.product_names + " | Marque : " + hit.fields.marques + " | Boutique : " +hit.fields.vendeurs}/>
 
      <link rel="canonical" href= {"/Algerie/informatique/Composants_pc/"+ name} />
