...
const Page = () => {
  ...
  const { previousData, data = previousData, loading } = useQuery(query, { variables })
    ...
    return (
      ...
      <meta name="description" content={names + " Algérie | Prix le moins cher : " + price + " DA | "+ categories +   " | Marque : " + marques + " | Specs : " +description1}/>
      ...
      <meta property="og:description" content={names + " Algérie | Prix le moins cher : " + price + " DA | "+ categories +   " | Marque : " + marques + " | Boutique : " +description1}/>
