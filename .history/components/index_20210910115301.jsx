...
useEffect(()=>{
  ...
  <header class="bg-gradient-dark position-fixed w-100 z-index-2">
    ...
    <svg style={{transform:"scale(-1,1) translate(-64,0)"}} class="waves-custom" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 40" preserveAspectRatio="none" shape-rendering="auto" >
      <defs>
