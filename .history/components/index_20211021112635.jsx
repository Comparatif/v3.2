...
useEffect(()=>{
  ...
  api.search()
    ...
    return (
      ...
      <meta name="description" content="Comparer les prix pour vos achats en ligne avec idealo.fr, comparateur de prix pour acheter moins cher ! ✓ Avis ✓ Tests produits ✓ Comparatifs. Comparateur de prix Algérie. Matériel informatique : cartes graphiques, processeurs, cartes mères... Laptop & PC fixes "/>
