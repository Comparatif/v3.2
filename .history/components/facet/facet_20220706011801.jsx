...
export const Facets = ({ data, id }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" class="btn bg-gradient-info mb-0" type="button" data-bs-toggle="offcanvas" data-bs-target={id ? ("#"+ id) : "canvas"} aria-controls="offcanvasScrolling">Filtres</button>


<div class={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id={id ? id : "canvas"} aria-labelledby="offcanvasScrollingLabel">
