        ...
        {facet.entries.map((entry) => {
          ...
          return (
            ...
            <div
              ...
              <div class="col-md-6 col-sm-6 col-6 mt-0 text-center">{entry.label}</div>  <div class={isSelected ? 'btn bg-gradient-info py-1 px-2 mb-0' : 'btn bg-gradient-secondary py-1 px-2 mb-0'}>{entry.count}</div>
            </div>
