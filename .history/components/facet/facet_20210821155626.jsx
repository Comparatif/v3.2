        ...
        {facet.entries.map((entry) => {
          ...
          return (
            ...
            <li
              ...
              class={isSelected ? 'btn bg-gradient-primary p-1 mb-0' : 'btn bg-gradient-secondary p-1 mb-0'}
              key={entry.label}
              onClick={() => {
                api.toggleFilter({ identifier: facet.identifier, value: entry.label });
                api.search();
              }}>
              {entry.label} - <div class="btn bg-gradient-primary p-1 mb-0">{entry.count}</div>
            </li>
