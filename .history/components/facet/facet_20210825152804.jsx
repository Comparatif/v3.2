        ...
        {facet.entries.map((entry) => {
          ...
          return (
            ...
            <div
              ...
              <div style={{cursor: "pointer"}} class="col-md-11 col-sm-11 col-11 no-of2 p-0"> {entry.label}</div>  
...
<div class={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
  <div class="offcanvas-header pb-0">
    ...
    <i  class={width < 767.98 ? "ni ni-bold-up no-overflow col-12" : "ni ni-bold-left no-overflow"} data-bs-dismiss="offcanvas" aria-label="Close"></i>
