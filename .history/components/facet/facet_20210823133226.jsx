        ...
        {facet.entries.map((entry) => {
          ...
          return (
            ...
            <li
              ...
              <div class="no-overflow">{entry.label}</div>  <div class={isSelected ? 'btn bg-gradient-info py-1 px-2 mb-0' : 'btn bg-gradient-secondary py-1 px-2 mb-0'}>{entry.count}</div>
            </li>
