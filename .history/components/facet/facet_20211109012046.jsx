...
const RefinementFacet = ({ facet, ref }) => {
...
<div class={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
  ...
  {data?.facets.map((facet) => {
    ...
    return <RefinementFacet  ref={ref} facet={facet} />
  })}
  </div>
