      ...
      <div class="filters container">
        {facet.entries.map((entry) => {
          ...
          return (
            <>
            <div
              class={isSelected ? ' row justify-content-between text-bold mb-1' : 'row justify-content-between no-overflow mb-1'}
              ...
              <div class="w-75">{entry.label}</div>  <div class={isSelected ? 'btn bg-gradient-info py-1 px-2 mb-0' : 'btn bg-gradient-secondary py-1 px-2 mb-0'}>{entry.count}</div>
            </div>
