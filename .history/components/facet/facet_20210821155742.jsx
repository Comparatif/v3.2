      ...
      <div class="filters">
        {facet.entries.map((entry) => {
          ...
          return (
            <>
            <li
              class={isSelected ? ' text-bold no-overflow justify-content-between' : 'no-overflow justify-content-between'}
              ...
              {entry.label}  <div class={isSelected ? 'btn bg-gradient-primary p-1 mb-0' : 'btn bg-gradient-secondary p-1 mb-0'}>{entry.count}</div>
            </li>
