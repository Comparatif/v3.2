...
const RefinementFacet = ({ facet }) => {
  ...
  return (
    ...
    <button key={facet.identifier} class="btn bg-gradient-info dropdown-toggle mb-0 w-auto sub-filters me-2 filters" type="button" id={facet.label} data-bs-toggle="dropdown" aria-expanded="false">
    {facet.label}
  </button>
