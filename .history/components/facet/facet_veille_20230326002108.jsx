...
export const FacetsVeille = ({ data, id }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" className="btn bg-gradient-info mb-0 px-1 py-1" type="button" data-bs-toggle="offcanvas" data-bs-target={id ? ("#"+ 'id' + id) : "canvas"} aria-controls="offcanvasScrolling">Filtres</button>


<div className={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id={id ? 'id'+ id : "canvas"} aria-labelledby="offcanvasScrollingLabel">
