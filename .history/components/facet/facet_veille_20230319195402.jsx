...
export const FacetsVeille = ({ data, id }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" className="btn bg-gradient-info mb-0 p-2" type="button" data-bs-toggle="offcanvas" data-bs-target={id ? ("#"+ 'id' + id) : "canvas"} aria-controls="offcanvasScrolling">Filtres</button>
