      ...
      <div class="filters ">
        {facet.entries.map((entry) => {
          ...
          return (
            <>
            <li
              class={isSelected ? ' text-bold no-overflow justify-content-between mb-1' : 'no-overflow justify-content-between mb-1'}
              ...
              <div class="col-md-2 col-sm-2 col-2" ><div class={isSelected ? 'btn bg-gradient-info py-1 px-2 mb-0' : 'btn bg-gradient-secondary py-1 px-2 mb-0'}>{entry.count}</div>
              </div>
              </div>
              </li>
