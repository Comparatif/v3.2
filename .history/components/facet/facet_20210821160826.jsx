      ...
      <div class="filters ">
        {facet.entries.map((entry) => {
          ...
          return (
            <>
            <li
              class={isSelected ? ' text-bold no-overflow mb-1' : 'no-overflow'}
              ...
              <div>{entry.label}</div>  <div class={isSelected ? 'btn bg-gradient-primary p-1 mb-0' : 'btn bg-gradient-secondary p-1 mb-0'}>{entry.count}</div>
            </li>
