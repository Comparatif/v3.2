        ...
        {facet.entries.map((entry) => {
          ...
          return (
            ...
            <li
              ...
              {entry.label}</div>  <div class="col-md-4 col-sm-4 col-4 mb-1 text-end ps-1 pe-3" ><div class={isSelected ? 'btn bg-gradient-info py-1 px-2 mb-0' : 'btn bg-gradient-secondary py-1 px-2 mb-0'}>{entry.count}</div>
              </div>
              </li>
