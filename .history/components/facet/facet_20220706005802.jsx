...
export const Facets = ({ data }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" class="btn bg-gradient-info mb-0" type="button" data-bs-toggle="offcanvas" data-bs-target={"#"+ ()=> generateId()} aria-controls="offcanvasScrolling">Filtres</button>
