        ...
        {facet.entries.map((entry) => {
          ...
          return (
            ...
            <div
              ...
              <FilterLink className="facet-custom" ref={ref} filter={{ identifier: facet.identifier, value: entry.label }} > 
              {entry.label}
              <style jsx>{`
...
export const Facets = ({ data }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" className="btn bg-gradient-info mb-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">Filtres</button>


<div className={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
