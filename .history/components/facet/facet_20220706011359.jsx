...
export const Facets = ({ data, id }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" class="btn bg-gradient-info mb-0" type="button" data-bs-toggle="offcanvas" data-bs-target={"#"+ id} aria-controls="offcanvasScrolling">Filtres</button>
