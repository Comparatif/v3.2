...
export const FacetsVeille = ({ data, id }) => {
  const { height, width } = useWindowDimensions();
  
  return (
    <>
    <button id="btn-fontsize" className="btn bg-gradient-info mb-0 p-2" type="button" data-bs-toggle="offcanvas" data-bs-target={id ? ("#"+ toString(id) : "canvas"} aria-controls="offcanvasScrolling">Filtres</button>


<div className={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id={id ? toString(id) : "canvas"} aria-labelledby="offcanvasScrollingLabel">
