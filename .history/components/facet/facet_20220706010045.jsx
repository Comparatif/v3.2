      ...
      <div class="filters container">
          ...
          return (
            ...
            <div
              ...
              <div style={{cursor: "pointer"}} class="col-md-10 col-sm-10 col-10 no-of2 p-0">
...
export const Facets = ({ data }) => {
  ...
  return (
    <>
    <button id="btn-fontsize" class="btn bg-gradient-info mb-0" type="button" data-bs-toggle="offcanvas" data-bs-target={"#"+ toString(generateId)} aria-controls="offcanvasScrolling">Filtres</button>


<div class={ width < 767.98 ? "offcanvas offcanvas-top h-50" : "offcanvas offcanvas-start" } data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id={toString(generateId())} aria-labelledby="offcanvasScrollingLabel">
