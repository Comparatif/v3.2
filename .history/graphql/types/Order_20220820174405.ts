                ...
                if (queryResults.length > 0) {
                    ...
                    const result = {
                        pageInfo: {
                            ...
                            endCursor: endCursor,
                            hasPrevPage: secondQueryResultsPrev.length >= args.first, // if the number of items requested is greater than the response of the second query, we have another page
